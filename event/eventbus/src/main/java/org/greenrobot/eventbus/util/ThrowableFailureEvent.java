...
/**
 * A generic failure event, which can be used by apps to propagate thrown exceptions. Used as
 * default failure event by {@link AsyncExecutor}.
 */
public class ThrowableFailureEvent implements HasExecutionScope {
  ...
  /**
   * @param suppressErrorUi true indicates to the receiver that no error UI (e.g. dialog) should now
   *     displayed.
   */
