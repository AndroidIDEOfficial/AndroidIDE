...
public class VirtualKeysConstants {
  ...
  public static class EXTRA_KEY_DISPLAY_MAPS {
    ...
    public static final VirtualKeyDisplayMap WELL_KNOWN_CHARACTERS_DISPLAY =
        new VirtualKeyDisplayMap() {
          {
            // well known characters // https://en.wikipedia.org/wiki/{Enter_key, Tab_key,
            // Delete_key}
        ...
        new VirtualKeyDisplayMap() {
          {
            ...
            // home key can mean "goto the beginning of line" or "goto first page" depending on
        ...
        new VirtualKeyDisplayMap() {
          {
            ...
            // https://en.wikipedia.org/wiki/{Function_key, Alt_key, Control_key, Esc_key}
            // put("FN", "FN"); // no ISO character exists
            put(
                "CTRL",
                "⎈"); // ISO character "U+2388 ⎈ HELM SYMBOL" is unknown to people and never printed
                      // on computers, however "U+25C7 ◇ WHITE DIAMOND" is a nice presentation, and
                      // "^" for terminal app and mac is often used
            put(
                "ALT",
                "⎇"); // ISO character "U+2387 ⎇ ALTERNATIVE KEY SYMBOL'" is unknown to people and
                      // only printed as the Option key "⌥" on Mac computer
            put(
                "ESC",
                "⎋"); // ISO character "U+238B ⎋ BROKEN CIRCLE WITH NORTHWEST ARROW" is unknown to
      ...
      new VirtualKeyDisplayMap() {
        {
          ...
          put(
              "RETURN",
              "ENTER"); // Technically different keys, but most applications won't see the
                        // difference
          put("FUNCTION", "FN");
          // no alias for ALT
