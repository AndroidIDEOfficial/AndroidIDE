...
public interface IProcessExecutor {
     ...
     * @return The exit code of the command
     */
    int exec (ProcessStreamsHolder holder, String cwd, boolean redirectErr, String... args) throws IOException, InterruptedException;
     ...
     * @param args Arguments for {@code cmd}
     */
    void execAsync (ProcessStreamsHolder holder, IProcessExitListener onExit, String cwd, boolean redirectErr, String... args) throws IOException;
}
