...
public class BitmapDrawableParser extends IDrawableParser {
    ...
    protected BitmapDrawableParser (XmlPullParser parser, IResourceTable resourceFinder, DisplayMetrics displayMetrics, int minDepth) {
    ...
    public Drawable parseDrawable () throws Exception {
        ...
        final var bitmap = new BitmapDrawable (BaseApplication.getBaseInstance ().getResources (), toBitmap (dr));
    ...
    private Bitmap toBitmap (@NonNull Drawable dr) {
        ...
        if (dr.getIntrinsicWidth () > 0 && dr.getIntrinsicHeight () > 0) {
            bit = Bitmap.createBitmap (dr.getIntrinsicWidth (), dr.getIntrinsicHeight (), Bitmap.Config.ARGB_8888);
        } else {
