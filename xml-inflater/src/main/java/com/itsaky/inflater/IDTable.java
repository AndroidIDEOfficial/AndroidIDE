...
public class IDTable {
     ...
     *
     * <p>For example : if android:id="@+id/my_id" is provided for view, then an entry will be
     * created in this map with the key : 'my_id' and a random integer as the value.
     *
