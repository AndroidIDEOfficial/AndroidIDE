...
public interface IViewGroup extends IView {
    ...
    /**
     * Unregister the given hierarchy change listener from this
     * view group.
     *
    ...
    /**
     * A listener which can be used to get notification when a
     * children is added or removed from an {@link IViewGroup}.
     *
     * @author Akash Yadav
     */
    public static interface OnHierarchyChangeListener {
        ...
        /**
         * Called when a child view is added in the view group
         * to which this listener is attached.
         * @param view The view that was added.
         */
        void onViewAdded (IView view);
    
        /**
         * Called when a child view is removed from the view group
         * to which this listener is attached.
         *
