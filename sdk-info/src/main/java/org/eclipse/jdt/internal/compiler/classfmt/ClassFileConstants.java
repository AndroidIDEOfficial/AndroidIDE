...
public final class ClassFileConstants {
    ...
    /**
     * From classfile version 52 (compliance 1.8 up), meaning that a formal parameter is mandated by
     * a language specification, so all compilers for the language must emit it.
     */
