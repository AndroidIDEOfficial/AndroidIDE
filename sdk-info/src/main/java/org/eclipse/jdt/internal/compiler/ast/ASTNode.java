...
public abstract class ASTNode {
  ...
  public static final int Bit1 =
      0x1; // return type (operator) | name reference kind (name ref) | add assertion (type decl) |
  ...
  public static final int Bit3 =
      0x4; // return type (operator) | name reference kind (name ref) | implicit this (this ref) |
           // is argument(local)
  ...
  public static final int Bit5 =
      0x10; // value for return (expression) | has all method bodies (unit) | supertype ref (type
            // ref) | resolved (field decl)| name ref (yield result value)
  public static final int Bit6 =
      0x20; // depth (name ref, msg) | ignore need cast check (cast expression) | error in signature
  ...
  public static final int Bit10 =
      0x200; // depth (name ref, msg) | operator (operator) | is anonymous type (type decl) | is
  ...
  public static final int Bit15 =
      0x4000; // is unnecessary cast (expression) | is varargs (type ref) | isSubRoutineEscaping
  ...
  public static final int Bit17 =
      0x10000; // compound assigned (reference lhs) | unchecked (msg, alloc, explicit constr call)
  ...
  public static final int Bit20 =
      0x80000; // contains syntax errors (method declaration, type declaration, field declarations,
               // initializer), typeref: <> name ref: lambda capture)
  public static final int Bit21 =
      0x100000; // for all declarations that can contain type references that have type annotations
                // | insideExpressionStatement
  public static final int Bit22 =
      0x200000; // parenthesis count (expression) | used (import reference) shadows outer local
                // (local declarations)
  public static final int Bit23 =
      0x400000; // parenthesis count (expression) | second or later declarator in declaration (local
                // declarations)
  ...
  public static final int Bit30 =
      0x20000000; // elseif (if statement) | try block exit (try statement) | fall-through (case
  ...
  public static final int Bit31 =
      0x40000000; // local declaration reachable (local decl) | ignore raw type check (type ref) |
