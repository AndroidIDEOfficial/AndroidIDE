  ...
  public static final boolean camelCaseMatch(
    ...
    while (true) {
      ...
      if (iPattern == patternEnd) { // we have exhausted pattern...
        // it's a match if the name can have additional parts (i.e. uppercase characters) or is also
        // exhausted
      ...
      while (true) {
        ...
        if (nameChar < ScannerHelper.MAX_OBVIOUS) {
          ...
          if ((charNature & (ScannerHelper.C_LOWER_LETTER | ScannerHelper.C_SPECIAL)) != 0) {
            ...
            // nameChar is digit => break if the digit is current pattern character otherwise
            // consume it
