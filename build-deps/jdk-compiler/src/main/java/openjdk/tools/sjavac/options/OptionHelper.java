...
import openjdk.tools.javac.main.CommandLine;
import openjdk.tools.sjavac.Transformer;

/**
 * This class is used to decode sjavac options.
 * See openjdk.tools.sjavac.options.Options for example usage.
 *
    ...
    void traverse(String[] args) {
        ...
        while (argIter.hasNext()) {
            ...
            if (arg.startsWith("-")) {
                ...
                for (openjdk.tools.javac.main.Option javacOpt : openjdk.tools.javac.main.Option.values()) {
