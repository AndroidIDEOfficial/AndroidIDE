...
import openjdk.tools.sjavac.Log.Level;
import openjdk.tools.sjavac.server.log.LazyInitFileLog;
import openjdk.tools.sjavac.server.log.LoggingOutputStream;

import static openjdk.tools.sjavac.Log.Level.ERROR;
import static openjdk.tools.sjavac.Log.Level.INFO;
