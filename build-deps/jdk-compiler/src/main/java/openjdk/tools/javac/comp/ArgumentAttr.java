...
import openjdk.tools.javac.comp.Attr.TargetInfo;
...
import openjdk.tools.javac.comp.DeferredAttr.LambdaReturnScanner;
import openjdk.tools.javac.comp.DeferredAttr.SwitchExpressionScanner;
import openjdk.tools.javac.comp.Infer.PartiallyInferredMethodType;
import openjdk.tools.javac.comp.Resolve.MethodResolutionPhase;
...
import openjdk.tools.javac.tree.JCTree.JCParens;
...
import static openjdk.tools.javac.code.TypeTag.DEFERRED;
import static openjdk.tools.javac.code.TypeTag.FORALL;
import static openjdk.tools.javac.code.TypeTag.METHOD;
