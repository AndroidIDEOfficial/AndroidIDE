...
public class ProjectFinder {
    ...
    private static void proceedModule(File file, File module, AndroidProject project)
        ...
        if (!module.exists()
                || !projectGradle.exists()
                || !moduleGradle.exists()
                || !manifest.exists()) return;
        ...
        JSONObject obj =
                new XmlToJson.Builder(FileUtil.readFile(manifest.getAbsolutePath()))
                        .build()
                        .toJson();
        ...
        if (obj.has("manifest")
            ...
            String iconRes =
                    obj.getJSONObject("manifest")
                            .getJSONObject("application")
                            .getString("android:icon");
