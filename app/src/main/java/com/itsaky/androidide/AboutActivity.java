...
public class AboutActivity extends StudioActivity {
     ...
     * display the language in a localized version. For example : Language: हिन्दी - < name of
     * author >
     *
    ...
    private List<Pair<String, String>> createTranslationsList() {
        ...
        list.add(Pair.create("Portuguese-Brazilian", "Ashburn'XS (Lukas Lewis)"));
        return list;
    }
    ...
    private void setupLicenses() {
        ...
        licenses.add(
                new License(
                        "Guava-Android", "Apache License 2.0", "https://github.com/google/guava"));
        ...
        licenses.add(
                new License(
                        "JavaPoet", "Apache License 2.0", "https://github.com/square/JavaPoet"));
        licenses.add(
                new License(
                        "Zip4j",
                        "Apache License 2.0",
