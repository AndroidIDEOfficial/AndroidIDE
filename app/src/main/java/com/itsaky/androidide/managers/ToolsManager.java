...
public class ToolsManager {
    ...
    + "\n    project.name = rootProject.getName()"
    + "\n    project.displayName = rootProject.getDisplayName()"
    + "\n    project.description = rootProject.getDescription()"
    + "\n    project.path = rootProject.getPath()"
    + "\n    "
    + "\n    def tasks = rootProject.tasks"
    + "\n    if(tasks != null && tasks.size() > 0) {"
    + "\n        addTasks(project, rootProject)"
    + "\n    }"
    + "\n    "
    + "\n    rootProject.subprojects.forEach { sub ->"
    + "\n        addIDEProject(project, sub);"
    + "\n    }"
    + "\n    "
    + "\n    File out = new File(\"" + Environment.PROJECT_DATA_FILE.getAbsolutePath() + "\")"
    + "\n    out << new JsonBuilder( project ).toPrettyString()"
    + "\n    "
    ...
    + "\n    } else {"
    + "\n        println \"AndroidIDE: Cannot build variants of project: ${module.name}\""
    + "\n    }"
    + "\n    "
    + "\n    if(variants != null) {"
