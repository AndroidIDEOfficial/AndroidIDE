...
public class SearchListAdapter extends RecyclerView.Adapter<SearchListAdapter.VH> {
    ...
    public SearchListAdapter(Map<File, List<SearchResult>> results, OnFileClickListener fileListener, OnMatchClickListener matchListener) {
        if (results == null)
            results = new HashMap<>();
    ...
    public void onBindViewHolder(SearchListAdapter.VH p1, int p2) {
        ...
        final int color = ContextCompat.getColor(binding.icon.getContext(), com.itsaky.androidide.R.color.secondaryColor);
    ...
    public class ChildAdapter extends RecyclerView.Adapter<ChildVH> {
        ...
        public SearchListAdapter.ChildVH onCreateViewHolder(ViewGroup p1, int p2) {
            return new ChildVH(LayoutSearchResultItemBinding.inflate(LayoutInflater.from(p1.getContext())));
        }
