...
public class DiagnosticsAdapter extends RecyclerView.Adapter<DiagnosticsAdapter.VH> {
    ...
    public DiagnosticsAdapter.VH onCreateViewHolder(ViewGroup p1, int p2) {
        return new VH(LayoutDiagnosticGroupBinding.inflate(LayoutInflater.from(p1.getContext()), p1, false));
    }
    ...
    public void onBindViewHolder(DiagnosticsAdapter.VH p1, int p2) {
        ...
        final int color = ContextCompat.getColor(binding.info.icon.getContext(), R.color.secondaryColor);
        ...
        binding.diagnostics.setAdapter(new DiagnosticItemAdapter (group.diagnostics, group.file, listener));
