...
public class EditorBottomSheetTabAdapter extends FragmentStateAdapter {
  ...
  public EditorBottomSheetTabAdapter(@NonNull FragmentActivity fragmentActivity) {
    ...
    this.fragments.add(
        new Tab(fragmentActivity.getString(R.string.build_output), new SimpleOutputFragment()));
    this.fragments.add(
        new Tab(fragmentActivity.getString(R.string.app_logs), new LogViewFragment()));
    this.fragments.add(
        new Tab(fragmentActivity.getString(R.string.ide_logs), new IDELogFragment()));
    this.fragments.add(
        new Tab(fragmentActivity.getString(R.string.view_diags), new DiagnosticsListFragment()));
    this.fragments.add(
        new Tab(
            fragmentActivity.getString(R.string.view_search_results), new SearchResultFragment()));
  }
