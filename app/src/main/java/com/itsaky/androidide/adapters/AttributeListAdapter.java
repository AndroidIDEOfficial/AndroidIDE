...
public class AttributeListAdapter extends RecyclerView.Adapter <AttributeListAdapter.VH> {
    
    private final List <XMLAttribute> attributes;
    private final OnClickListener clickListener;
    
    public AttributeListAdapter (List<XMLAttribute> attributes, OnClickListener clickListener) {
