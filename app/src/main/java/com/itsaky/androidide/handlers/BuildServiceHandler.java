...
public class BuildServiceHandler extends IDEHandler implements BuildListener {
  ...
  public void onProjectLoaded(IDEProject project, Optional<IDEModule> appModule) {
    ...
    if (appModule.isPresent()) {
      ...
      final List<String> paths =
          app.dependencies.stream().filter(this::isClasspathValid).collect(Collectors.toList());
  ...
  public void prepareBuild() {
    ...
    activity()
        .setStatus(
            activity().getString(isFirstBuild ? R.string.preparing_first : R.string.preparing));
    if (isFirstBuild) {
