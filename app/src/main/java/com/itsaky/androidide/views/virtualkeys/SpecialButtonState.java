...
public class SpecialButtonState {
     ...
     *
     * @param extraKeysView The {@link VirtualKeysView} instance in which the {@link SpecialButton}
     *                      is to be registered.
     */
    ...
    public void setIsActive(boolean value) {
        isActive = value;
        buttons.forEach(button -> button.setTextColor(value ? mVirtualKeysView.getButtonActiveTextColor() : mVirtualKeysView.getButtonTextColor()));
    }
