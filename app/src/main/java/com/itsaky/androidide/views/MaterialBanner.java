...
public class MaterialBanner extends CoordinatorLayout {
	...
	public void show() {
		...
		this.binding.rightButton.setOnClickListener(v -> { if(positiveListener == null) dismiss(); else { positiveListener.onClick(MaterialBanner.this); dismiss(); } });
		this.binding.leftButton.setOnClickListener(v -> { if(negativeListener == null) dismiss(); else { negativeListener.onClick(MaterialBanner.this); dismiss(); } });
