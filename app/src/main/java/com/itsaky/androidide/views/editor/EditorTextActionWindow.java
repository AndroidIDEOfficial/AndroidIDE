        ...
        View.MeasureSpec.makeMeasureSpec(
            (int)
                ((int) (260 * editor.getDpUnit())
                    - dp16 * 2), // 260dp at most and 16dp margins from top and bottom
            View.MeasureSpec.AT_MOST));
  ...
  public void displayWindow() {
    ...
    float handleLeftX =
        this.editor.getOffset(
            this.editor.getCursor().getLeftLine(), this.editor.getCursor().getLeftColumn());
    float handleRightX =
        this.editor.getOffset(
            this.editor.getCursor().getRightLine(), this.editor.getCursor().getRightColumn());
