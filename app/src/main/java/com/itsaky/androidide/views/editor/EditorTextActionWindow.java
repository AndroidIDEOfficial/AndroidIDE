 ...
 */
public class EditorTextActionWindow extends EditorPopupWindow implements IDEEditor.ITextActionPresenter {
    ...
    public void bindEditor (@NonNull IDEEditor editor) {
        ...
        this.editor.getComponent (io.github.rosemoe.sora.widget.component.EditorTextActionWindow.class).setEnabled (false);
        ...
        this.editor.subscribeEvent (SelectionChangeEvent.class, (event, unsubscribe) -> {
            ...
            if (event.isSelected ()) {
                ...
                if (event.getCause () == SelectionChangeEvent.CAUSE_TAP
                        ...
                        && !isShowing () && !this.editor.getText ().isInBatchEdit ()) {
                    this.editor.post (this::displayWindow);
                    show = true;
                } else {
                    dismiss ();
    ...
    public void displayWindow () {
        ...
        float handleLeftX = this.editor.getOffset (this.editor.getCursor ().getLeftLine (), this.editor.getCursor ().getLeftColumn ());
        float handleRightX = this.editor.getOffset (this.editor.getCursor ().getRightLine (), this.editor.getCursor ().getRightColumn ());
