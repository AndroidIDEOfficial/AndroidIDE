...
public class ColorPickerView extends LinearLayout {
    ...
    private final Slider.OnChangeListener mValueChangeListener = (slider, value, fromUser) -> {
    ...
    private void init () {
        ...
        this.binding.pick.setOnClickListener (v -> {
    ...
    /**
     * Set the color value for this color picker.
     * this will in turn update value of the sliders
     * and the color preview.
    ...
    /**
     * Get the int value of the color from the current
     * values of alpha, red, green and blue color values.
    ...
    /**
     * A TextWatcher that is used to listen for text updates in the
