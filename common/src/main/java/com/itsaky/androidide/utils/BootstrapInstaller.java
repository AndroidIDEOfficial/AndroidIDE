        ...
        return CompletableFuture.runAsync(
                () -> {
                    ...
                    try (final var assetIn =
                                    context.getAssets()
                                            .open(
                                                    ToolsManager.getArchSpecificAsset(
                                                            "bootstrap.zip"));
                        ...
                        while ((entry = zip.getNextEntry()) != null) {
                            ...
                            if (entry.getName().equals("SYMLINKS.txt")) {
                                ...
                                if (Files.exists(targetFilePath)
                                        && !Files.isDirectory(targetFilePath)) {
                                    try {
                                ...
                                if (!isDirectory) {
                                    ...
                                    if (zipEntryName.startsWith("bin/")
                                        ...
                                        notify(
                                                listener,
                                                context.getString(R.string.msg_chmod_exec));
                        ...
                        for (Pair<String, String> symlink : symlinks) {
                            notify(
                                    listener,
                                    context.getString(
                                            R.string.msg_linking, symlink.second, symlink.first));
