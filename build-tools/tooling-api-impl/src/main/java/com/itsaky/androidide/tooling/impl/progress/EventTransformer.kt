...
class EventTransformer {
    companion object {
        ...
        private fun projectConfigurationDescriptor(
            ...
            com.itsaky.androidide.tooling.events.configuration
        ...
        @JvmStatic
        fun taskProgress(
            event: org.gradle.tooling.events.task.TaskProgressEvent
        ): TaskProgressEvent =
            TaskProgressEvent(
                eventTime = event.eventTime,
                displayName = event.displayName,
        ...
        @JvmStatic
        fun testProgress(
            event: org.gradle.tooling.events.test.TestProgressEvent
        ): TestProgressEvent =
            TestProgressEvent(
                eventTime = event.eventTime,
                displayName = event.displayName,
        ...
        private fun transformDescriptor(
            ...
            com.itsaky.androidide.tooling.events.transform.TransformOperationDescriptor(
                ...
                dependencies =
                    descriptor.dependencies.mapNotNull { operationDescriptor(it) }.toSet())

        // ----------------------- WORK ITEM -------------------------
        @JvmStatic
        fun workStart(
            event: org.gradle.tooling.events.work.WorkItemStartEvent
        ): WorkItemStartEvent =
            WorkItemStartEvent(
                eventTime = event.eventTime,
                displayName = event.displayName,
        ...
        @JvmStatic
        fun workFinish(
            event: org.gradle.tooling.events.work.WorkItemFinishEvent
        ): WorkItemFinishEvent =
            WorkItemFinishEvent(
                eventTime = event.eventTime,
                displayName = event.displayName,
