...
public class FuzzySearch {
    ...
    /**
     * Inconsistent substrings lead to problems in matching. This ratio uses a heuristic called
     * "best partial" for when two strings are of noticeably different lengths.
     *
     * @param s1 Input string
     * @param s2 Input string
    ...
    /**
     * Splits the strings into tokens and computes intersections and remainders between the tokens
     * of the two strings. A comparison string is then built up and is compared using the simple
     * ratio algorithm. Useful for strings where words appear redundantly.
     *
     * @param s1 Input string
     * @param s2 Input string
    ...
    /**
     * Creates a <b>sorted</b> list of {@link ExtractedResult} which contain the top @param limit
     * most similar choices
     *
