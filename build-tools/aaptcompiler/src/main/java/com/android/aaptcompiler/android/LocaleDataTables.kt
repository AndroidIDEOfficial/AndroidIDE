...
internal val SCRIPT_CODES = arrayOf(
  /* 0  */ byteArrayOf('A'.toByte(), 'h'.toByte(), 'o'.toByte(), 'm'.toByte()),
  /* 1  */ byteArrayOf('A'.toByte(), 'r'.toByte(), 'a'.toByte(), 'b'.toByte()),
  /* 2  */ byteArrayOf('A'.toByte(), 'r'.toByte(), 'm'.toByte(), 'i'.toByte()),
  /* 3  */ byteArrayOf('A'.toByte(), 'r'.toByte(), 'm'.toByte(), 'n'.toByte()),
  /* 4  */ byteArrayOf('A'.toByte(), 'v'.toByte(), 's'.toByte(), 't'.toByte()),
  /* 5  */ byteArrayOf('B'.toByte(), 'a'.toByte(), 'm'.toByte(), 'u'.toByte()),
  /* 6  */ byteArrayOf('B'.toByte(), 'a'.toByte(), 's'.toByte(), 's'.toByte()),
  /* 7  */ byteArrayOf('B'.toByte(), 'e'.toByte(), 'n'.toByte(), 'g'.toByte()),
  /* 8  */ byteArrayOf('B'.toByte(), 'r'.toByte(), 'a'.toByte(), 'h'.toByte()),
  /* 9  */ byteArrayOf('C'.toByte(), 'a'.toByte(), 'n'.toByte(), 's'.toByte()),
  /* 10 */ byteArrayOf('C'.toByte(), 'a'.toByte(), 'r'.toByte(), 'i'.toByte()),
  /* 11 */ byteArrayOf('C'.toByte(), 'h'.toByte(), 'a'.toByte(), 'm'.toByte()),
  /* 12 */ byteArrayOf('C'.toByte(), 'h'.toByte(), 'e'.toByte(), 'r'.toByte()),
  /* 13 */ byteArrayOf('C'.toByte(), 'o'.toByte(), 'p'.toByte(), 't'.toByte()),
  /* 14 */ byteArrayOf('C'.toByte(), 'p'.toByte(), 'r'.toByte(), 't'.toByte()),
  /* 15 */ byteArrayOf('C'.toByte(), 'y'.toByte(), 'r'.toByte(), 'l'.toByte()),
  /* 16 */ byteArrayOf('D'.toByte(), 'e'.toByte(), 'v'.toByte(), 'a'.toByte()),
  /* 17 */ byteArrayOf('E'.toByte(), 'g'.toByte(), 'y'.toByte(), 'p'.toByte()),
  /* 18 */ byteArrayOf('E'.toByte(), 't'.toByte(), 'h'.toByte(), 'i'.toByte()),
  /* 19 */ byteArrayOf('G'.toByte(), 'e'.toByte(), 'o'.toByte(), 'r'.toByte()),
  /* 20 */ byteArrayOf('G'.toByte(), 'o'.toByte(), 't'.toByte(), 'h'.toByte()),
  /* 21 */ byteArrayOf('G'.toByte(), 'r'.toByte(), 'e'.toByte(), 'k'.toByte()),
  /* 22 */ byteArrayOf('G'.toByte(), 'u'.toByte(), 'j'.toByte(), 'r'.toByte()),
  /* 23 */ byteArrayOf('G'.toByte(), 'u'.toByte(), 'r'.toByte(), 'u'.toByte()),
  /* 24 */ byteArrayOf('H'.toByte(), 'a'.toByte(), 'n'.toByte(), 's'.toByte()),
  /* 25 */ byteArrayOf('H'.toByte(), 'a'.toByte(), 'n'.toByte(), 't'.toByte()),
  /* 26 */ byteArrayOf('H'.toByte(), 'a'.toByte(), 't'.toByte(), 'r'.toByte()),
  /* 27 */ byteArrayOf('H'.toByte(), 'e'.toByte(), 'b'.toByte(), 'r'.toByte()),
  /* 28 */ byteArrayOf('H'.toByte(), 'l'.toByte(), 'u'.toByte(), 'w'.toByte()),
  /* 29 */ byteArrayOf('H'.toByte(), 'm'.toByte(), 'n'.toByte(), 'g'.toByte()),
  /* 30 */ byteArrayOf('I'.toByte(), 't'.toByte(), 'a'.toByte(), 'l'.toByte()),
  /* 31 */ byteArrayOf('J'.toByte(), 'p'.toByte(), 'a'.toByte(), 'n'.toByte()),
  /* 32 */ byteArrayOf('K'.toByte(), 'a'.toByte(), 'l'.toByte(), 'i'.toByte()),
  /* 33 */ byteArrayOf('K'.toByte(), 'a'.toByte(), 'n'.toByte(), 'a'.toByte()),
  /* 34 */ byteArrayOf('K'.toByte(), 'h'.toByte(), 'a'.toByte(), 'r'.toByte()),
  /* 35 */ byteArrayOf('K'.toByte(), 'h'.toByte(), 'm'.toByte(), 'r'.toByte()),
  /* 36 */ byteArrayOf('K'.toByte(), 'n'.toByte(), 'd'.toByte(), 'a'.toByte()),
  /* 37 */ byteArrayOf('K'.toByte(), 'o'.toByte(), 'r'.toByte(), 'e'.toByte()),
  /* 38 */ byteArrayOf('L'.toByte(), 'a'.toByte(), 'n'.toByte(), 'a'.toByte()),
  /* 39 */ byteArrayOf('L'.toByte(), 'a'.toByte(), 'o'.toByte(), 'o'.toByte()),
  /* 40 */ byteArrayOf('L'.toByte(), 'a'.toByte(), 't'.toByte(), 'n'.toByte()),
  /* 41 */ byteArrayOf('L'.toByte(), 'e'.toByte(), 'p'.toByte(), 'c'.toByte()),
  /* 42 */ byteArrayOf('L'.toByte(), 'i'.toByte(), 'n'.toByte(), 'a'.toByte()),
  /* 43 */ byteArrayOf('L'.toByte(), 'i'.toByte(), 's'.toByte(), 'u'.toByte()),
  /* 44 */ byteArrayOf('L'.toByte(), 'y'.toByte(), 'c'.toByte(), 'i'.toByte()),
  /* 45 */ byteArrayOf('L'.toByte(), 'y'.toByte(), 'd'.toByte(), 'i'.toByte()),
  /* 46 */ byteArrayOf('M'.toByte(), 'a'.toByte(), 'n'.toByte(), 'd'.toByte()),
  /* 47 */ byteArrayOf('M'.toByte(), 'a'.toByte(), 'n'.toByte(), 'i'.toByte()),
  /* 48 */ byteArrayOf('M'.toByte(), 'e'.toByte(), 'r'.toByte(), 'c'.toByte()),
  /* 49 */ byteArrayOf('M'.toByte(), 'l'.toByte(), 'y'.toByte(), 'm'.toByte()),
  /* 50 */ byteArrayOf('M'.toByte(), 'o'.toByte(), 'n'.toByte(), 'g'.toByte()),
  /* 51 */ byteArrayOf('M'.toByte(), 'r'.toByte(), 'o'.toByte(), 'o'.toByte()),
  /* 52 */ byteArrayOf('M'.toByte(), 'y'.toByte(), 'm'.toByte(), 'r'.toByte()),
  /* 53 */ byteArrayOf('N'.toByte(), 'a'.toByte(), 'r'.toByte(), 'b'.toByte()),
  /* 54 */ byteArrayOf('N'.toByte(), 'k'.toByte(), 'o'.toByte(), 'o'.toByte()),
  /* 55 */ byteArrayOf('O'.toByte(), 'g'.toByte(), 'a'.toByte(), 'm'.toByte()),
  /* 56 */ byteArrayOf('O'.toByte(), 'r'.toByte(), 'k'.toByte(), 'h'.toByte()),
  /* 57 */ byteArrayOf('O'.toByte(), 'r'.toByte(), 'y'.toByte(), 'a'.toByte()),
  /* 58 */ byteArrayOf('O'.toByte(), 's'.toByte(), 'g'.toByte(), 'e'.toByte()),
  /* 59 */ byteArrayOf('P'.toByte(), 'a'.toByte(), 'u'.toByte(), 'c'.toByte()),
  /* 60 */ byteArrayOf('P'.toByte(), 'h'.toByte(), 'l'.toByte(), 'i'.toByte()),
  /* 61 */ byteArrayOf('P'.toByte(), 'h'.toByte(), 'n'.toByte(), 'x'.toByte()),
  /* 62 */ byteArrayOf('P'.toByte(), 'l'.toByte(), 'r'.toByte(), 'd'.toByte()),
  /* 63 */ byteArrayOf('P'.toByte(), 'r'.toByte(), 't'.toByte(), 'i'.toByte()),
  /* 64 */ byteArrayOf('R'.toByte(), 'u'.toByte(), 'n'.toByte(), 'r'.toByte()),
  /* 65 */ byteArrayOf('S'.toByte(), 'a'.toByte(), 'm'.toByte(), 'r'.toByte()),
  /* 66 */ byteArrayOf('S'.toByte(), 'a'.toByte(), 'r'.toByte(), 'b'.toByte()),
  /* 67 */ byteArrayOf('S'.toByte(), 'a'.toByte(), 'u'.toByte(), 'r'.toByte()),
  /* 68 */ byteArrayOf('S'.toByte(), 'g'.toByte(), 'n'.toByte(), 'w'.toByte()),
  /* 69 */ byteArrayOf('S'.toByte(), 'i'.toByte(), 'n'.toByte(), 'h'.toByte()),
  /* 70 */ byteArrayOf('S'.toByte(), 'o'.toByte(), 'r'.toByte(), 'a'.toByte()),
  /* 71 */ byteArrayOf('S'.toByte(), 'y'.toByte(), 'r'.toByte(), 'c'.toByte()),
  /* 72 */ byteArrayOf('T'.toByte(), 'a'.toByte(), 'l'.toByte(), 'e'.toByte()),
  /* 73 */ byteArrayOf('T'.toByte(), 'a'.toByte(), 'l'.toByte(), 'u'.toByte()),
  /* 74 */ byteArrayOf('T'.toByte(), 'a'.toByte(), 'm'.toByte(), 'l'.toByte()),
  /* 75 */ byteArrayOf('T'.toByte(), 'a'.toByte(), 'n'.toByte(), 'g'.toByte()),
  /* 76 */ byteArrayOf('T'.toByte(), 'a'.toByte(), 'v'.toByte(), 't'.toByte()),
  /* 77 */ byteArrayOf('T'.toByte(), 'e'.toByte(), 'l'.toByte(), 'u'.toByte()),
  /* 78 */ byteArrayOf('T'.toByte(), 'f'.toByte(), 'n'.toByte(), 'g'.toByte()),
  /* 79 */ byteArrayOf('T'.toByte(), 'h'.toByte(), 'a'.toByte(), 'a'.toByte()),
  /* 80 */ byteArrayOf('T'.toByte(), 'h'.toByte(), 'a'.toByte(), 'i'.toByte()),
  /* 81 */ byteArrayOf('T'.toByte(), 'i'.toByte(), 'b'.toByte(), 't'.toByte()),
  /* 82 */ byteArrayOf('U'.toByte(), 'g'.toByte(), 'a'.toByte(), 'r'.toByte()),
  /* 83 */ byteArrayOf('V'.toByte(), 'a'.toByte(), 'i'.toByte(), 'i'.toByte()),
  /* 84 */ byteArrayOf('X'.toByte(), 'p'.toByte(), 'e'.toByte(), 'o'.toByte()),
  /* 85 */ byteArrayOf('X'.toByte(), 's'.toByte(), 'u'.toByte(), 'x'.toByte()),
  /* 86 */ byteArrayOf('Y'.toByte(), 'i'.toByte(), 'i'.toByte(), 'i'.toByte()),
  /* 87 */ byteArrayOf('~'.toByte(), '~'.toByte(), '~'.toByte(), 'A'.toByte()),
  /* 88 */ byteArrayOf('~'.toByte(), '~'.toByte(), '~'.toByte(), 'B'.toByte()))
