...
public interface ILanguageServer {
    ...
    /**
     * Initialize this language server with the given params. Subclasses are expected to throw
     * {@link AlreadyInitializedException} if the language server was already initialized.
     *
