...
final class CommandLineOptionsParser {
    ...
    /**
     * Parse multiple --lines flags, like {"1:12,14,20:36", "40:45,50"}. Multiple ranges can be
     * given with multiple --lines flags or separated by commas. A single line can be set by a
     * single number. Line numbers are {@code 1}-based, but are converted to the {@code 0}-based
     * numbering used internally by google-java-format.
     */
            ...
            if (!arg.startsWith("@")) {
                ...
                try {
                    ...
                    throw new UncheckedIOException(
                            path + ": could not read file: " + e.getMessage(), e);
                }
            }
        }
    }
