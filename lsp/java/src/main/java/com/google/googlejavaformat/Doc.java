...
public abstract class Doc {
    ...
    public enum FillMode {
        /**
         * If a {@link Level} will not fit on one line, all of its {@code UNIFIED} {@link Break}s
         * will be broken.
         */
        UNIFIED,

        /**
         * If a {@link Level} will not fit on one line, its {@code INDEPENDENT} {@link Break}s will
         * be broken independently of each other, to fill in the {@link Level}.
         */
        INDEPENDENT,

        /**
         * A {@code FORCED} {@link Break} will always be broken, and a {@link Level} it appears in
    ...
    /**
     * Compute the {@code Doc}'s flat value. Not defined (and never called) if contains forced
     * breaks.
     *
    ...
    static final class Level extends Doc {
        ...
        /**
         * Groups of {@link Doc}s that are children of the current {@link Level}, separated by
         * {@link Break}s.
         */
        ...
        private static void splitByBreaks(
                List<Doc> docs, List<List<Doc>> splits, List<Break> breaks) {
            splits.clear();
            breaks.clear();
    ...
    public static final class Token extends Doc implements Op {
         ...
         * @param realOrImaginary did this {@link Input.Token} appear in the input, or was it
         *     generated incorrectly?
         * @param plusIndentCommentsBefore extra {@code plusIndent} for comments just before this
         *     token
    ...
    public static final class Break extends Doc implements Op {
        ...
        public State computeBreaks(CommentsHelper commentsHelper, int maxWidth, State state) {
            ...
            throw new UnsupportedOperationException(
                    "Did you mean computeBreaks(State, int, boolean)?");
        }
    ...
    static final class Tok extends Doc implements Op {
        ...
        @Override
        String computeFlat() {
            // TODO(cushon): commentsHelper.rewrite doesn't get called for spans that fit in a
            // single
            // line. That's fine for multi-line comment reflowing, but problematic for adding
            // missing
        ...
        public State computeBreaks(CommentsHelper commentsHelper, int maxWidth, State state) {
            ...
            int firstLineLength =
                    text.length() - Iterators.getLast(Newlines.lineOffsetIterator(text));
