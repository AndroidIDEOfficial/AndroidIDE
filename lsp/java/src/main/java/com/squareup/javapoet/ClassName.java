...
public final class ClassName extends TypeName implements Comparable<ClassName> {
    ...
    public boolean isAnnotated() {
        return super.isAnnotated()
                || (enclosingClassName != null && enclosingClassName.isAnnotated());
    }
    ...
    /**
     * Returns the enclosing class, like {@link Map} for {@code Map.Entry}. Returns null if this
     * class is not nested in another class.
     */
     ...
     * another class, this is equivalent to {@code enclosingClassName().nestedClass(name)}.
    ...
    public static ClassName get(Class<?> clazz) {
        ...
        checkArgument(
                !void.class.equals(clazz), "'void' type cannot be represented as a ClassName");
    ...
    /**
     * Returns a new {@link ClassName} instance for the given fully-qualified class name string.
     * This method assumes that the input is ASCII and follows typical Java style (lowercase package
     * names, UpperCamelCase class names) and may produce incorrect results or throw {@link
    ...
    /**
     * Returns a class name created from the given parts. For example, calling this with package
     * name {@code "java.util"} and simple names {@code "Map"}, {@code "Entry"} yields {@link
     * Map.Entry}.
     */
