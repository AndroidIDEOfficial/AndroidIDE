...
public final class TypeVariableName extends TypeName {
     ...
     * thing, we will make a TypeVariableName without bounds and add that to the {@code
     * typeVariables} map before looking up the bounds. Then if we encounter this TypeVariable again
     * while constructing the bounds, we can just return it from the map. And, the code that put the
     * entry in {@code variables} will make sure that the bounds are filled in before returning.
     */
    static TypeVariableName get(
        ...
        if (typeVariableName == null) {
            ...
            typeVariableName =
                    new TypeVariableName(element.getSimpleName().toString(), visibleBounds);
