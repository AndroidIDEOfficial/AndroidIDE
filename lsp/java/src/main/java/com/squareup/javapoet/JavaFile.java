...
public final class JavaFile {
    ...
    /**
     * Writes this to {@code directory} with the provided {@code charset} using the standard
     * directory structure.
     */
    ...
    /**
     * Writes this to {@code directory} with the provided {@code charset} using the standard
     * directory structure. Returns the {@link Path} instance to which source is actually written.
     */
    ...
    public static final class Builder {
        ...
        public Builder addStaticImport(ClassName className, String... names) {
            ...
            for (String name : names) {
                checkArgument(
                        name != null, "null entry in names array: %s", Arrays.toString(names));
        ...
        /**
         * Call this to omit imports for classes in {@code java.lang}, such as {@code
         * java.lang.String}.
         *
