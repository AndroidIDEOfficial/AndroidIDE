...
public class EditHelper {
    ...
    public static String printMethod(final ExecutableElement method, final ExecutableType parameterizedType, MethodTree source) {
    ...
    public static int indent(final JavacTask task, final CompilationUnitTree root, final ClassTree leaf) {
        SourcePositions pos = Trees.instance(task).getSourcePositions();
        LineMap lines = root.getLineMap();
    ...
    public static Position insertBefore(final JavacTask task, final CompilationUnitTree root, final Tree member) {
        SourcePositions pos = Trees.instance(task).getSourcePositions();
        LineMap lines = root.getLineMap();
    ...
    public static Position insertAfter(final JavacTask task, final CompilationUnitTree root, final Tree member) {
        SourcePositions pos = Trees.instance(task).getSourcePositions();
        LineMap lines = root.getLineMap();
