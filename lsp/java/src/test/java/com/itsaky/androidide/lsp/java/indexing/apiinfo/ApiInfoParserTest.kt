...
class ApiInfoParserTest {
  ...
  private lateinit var parser: ApiInfoParser
  ...
  fun testMultipleApiElements() {
    ...
    val parser = ApiInfoParser()
    assertThrows("The markup in the document following the root element must be well-formed.", XMLStreamException::class.java) {
      parser.parse(inputStream)
    }
  }
