 ...
 * {@link jaxp.xml.datatype.DatatypeConstants#DATETIME},
 * {@link jaxp.xml.datatype.DatatypeConstants#TIME},
 * {@link jaxp.xml.datatype.DatatypeConstants#DATE},
 * {@link jaxp.xml.datatype.DatatypeConstants#GYEARMONTH},
 * {@link jaxp.xml.datatype.DatatypeConstants#GMONTHDAY},
 * {@link jaxp.xml.datatype.DatatypeConstants#GYEAR},
 * {@link jaxp.xml.datatype.DatatypeConstants#GMONTH}, and
 * {@link jaxp.xml.datatype.DatatypeConstants#GDAY}
 ...
 *            or {@link jaxp.xml.datatype.DatatypeConstants#FIELD_UNDEFINED}.<br/>
 ...
 *       <td> {@link #getMonth()} </td>
 *       <td> 1 to 12 or {@link jaxp.xml.datatype.DatatypeConstants#FIELD_UNDEFINED} </td>
 *     </tr>
 *     <tr>
 *       <td><a name="datetimefield-day"/>day</td>
 *       <td> {@link #getDay()} </td>
 *       <td> Independent of month, max range is 1 to 31 or {@link jaxp.xml.datatype.DatatypeConstants#FIELD_UNDEFINED}.<br/>
 ...
 *       <td>{@link #getHour()}</td>
 *       <td>
 *         0 to 23 or {@link jaxp.xml.datatype.DatatypeConstants#FIELD_UNDEFINED}.
 ...
 *       <td> 0 to 59 or {@link jaxp.xml.datatype.DatatypeConstants#FIELD_UNDEFINED} </td>
 *     </tr>
 *     <tr>
 ...
 *       </td>
 *       <td>
 *         {@link #getSecond()} from 0 to 60 or {@link jaxp.xml.datatype.DatatypeConstants#FIELD_UNDEFINED}.<br/>
 ...
 *       <td> Number of minutes or {@link jaxp.xml.datatype.DatatypeConstants#FIELD_UNDEFINED}.
 ...
 *     {@link #toString()}, {@link jaxp.xml.datatype.DatatypeFactory#newXMLGregorianCalendar(String lexicalRepresentation)}</li>
 ...
 *     {@link jaxp.xml.datatype.DatatypeFactory}</li>
 ...
 *   <li>addition operation with {@link jaxp.xml.datatype.Duration}
 ...
 * @see jaxp.xml.datatype.Duration
 * @see jaxp.xml.datatype.DatatypeFactory
 * @since 1.5
 */
...
public abstract class XMLGregorianCalendar
         ...
         *
         * <p>Note: Always use the {@link jaxp.xml.datatype.DatatypeFactory} to
         ...
         *
         * <p>Set all int fields to {@link jaxp.xml.datatype.DatatypeConstants#FIELD_UNDEFINED} and reference fields
         * to null.</p>
         */
         ...
         * {@link jaxp.xml.datatype.DatatypeFactory#newXMLGregorianCalendar()},
         * {@link jaxp.xml.datatype.DatatypeFactory#newXMLGregorianCalendar(String lexicalRepresentation)},
         * {@link jaxp.xml.datatype.DatatypeFactory#newXMLGregorianCalendar(
         *   BigInteger year,
         *   int month,
         *   int day,
         ...
         *   int millisecond,
         *   int timezone)},
         * {@link jaxp.xml.datatype.DatatypeFactory#newXMLGregorianCalendar(GregorianCalendar cal)},
         * {@link jaxp.xml.datatype.DatatypeFactory#newXMLGregorianCalendarDate(
         *   int year,
         *   int month,
         *   int day,
         *   int timezone)},
         * {@link jaxp.xml.datatype.DatatypeFactory#newXMLGregorianCalendarTime(
         *   int hours,
         *   int minutes,
         *   int seconds,
         *   int timezone)},
     ...
     *   If year is {@link jaxp.xml.datatype.DatatypeConstants#FIELD_UNDEFINED}, then eon is set to <code>null</code>.
     */
     ...
     * <p>Set month.</p>
     *
     * <p>Unset this field by invoking the setter with a parameter value of {@link jaxp.xml.datatype.DatatypeConstants#FIELD_UNDEFINED}.</p>
     *
     ...
     * @param second value constraints are summarized in
     * <a href="#datetimefield-second">second field of date/time field mapping table</a>.
     * @param millisecond value of {@link jaxp.xml.datatype.DatatypeConstants#FIELD_UNDEFINED} indicates this
    ...
    public void setTime(int hour, int minute, int second, int millisecond) {
         ...
         * <code>year</code> or {@link jaxp.xml.datatype.DatatypeConstants#FIELD_UNDEFINED}.</p>
         *
         * <p>Value constraints for this value are summarized in
         * <a href="#datetimefield-year">year field of date/time field mapping table</a>.</p>
         *
        ...
        /**
         * <p>Return number of month or {@link jaxp.xml.datatype.DatatypeConstants#FIELD_UNDEFINED}.</p>
         *
         * <p>Value constraints for this value are summarized in
        ...
        /**
         * Return day in month or {@link jaxp.xml.datatype.DatatypeConstants#FIELD_UNDEFINED}.</p>
         *
         * <p>Value constraints for this value are summarized in
         ...
         * {@link jaxp.xml.datatype.DatatypeConstants#FIELD_UNDEFINED} if this optional field is not defined.
         *
         * <p>Value constraints for this value are summarized in
        ...
        /**
         * Return hours or {@link jaxp.xml.datatype.DatatypeConstants#FIELD_UNDEFINED}.
         * Returns {@link jaxp.xml.datatype.DatatypeConstants#FIELD_UNDEFINED} if this field is not defined.
         *
         * <p>Value constraints for this value are summarized in
        ...
        /**
         * Return minutes or {@link jaxp.xml.datatype.DatatypeConstants#FIELD_UNDEFINED}.</p>
         * Returns {@link jaxp.xml.datatype.DatatypeConstants#FIELD_UNDEFINED} if this field is not defined.
         *
         * <p>Value constraints for this value are summarized in
        ...
        /**
         * <p>Return seconds or {@link jaxp.xml.datatype.DatatypeConstants#FIELD_UNDEFINED}.</p>
         *
         * <p>Returns {@link jaxp.xml.datatype.DatatypeConstants#FIELD_UNDEFINED} if this field is not defined.
        ...
        public int getMillisecond() {
                ...
                if (fractionalSeconds == null) {
                        return jaxp.xml.datatype.DatatypeConstants.FIELD_UNDEFINED;
                }
         ...
         * does not return {@link jaxp.xml.datatype.DatatypeConstants#FIELD_UNDEFINED}.</p>
         *
     ...
     *   {@link jaxp.xml.datatype.DatatypeConstants#LESSER},
     *   {@link jaxp.xml.datatype.DatatypeConstants#EQUAL},
     *   {@link jaxp.xml.datatype.DatatypeConstants#GREATER} or
     *   {@link jaxp.xml.datatype.DatatypeConstants#INDETERMINATE}.
     *
     ...
     * returns {@link jaxp.xml.datatype.DatatypeConstants#EQUAL},
    ...
    public boolean equals(Object obj) {
        ...
        return compare((XMLGregorianCalendar) obj) == jaxp.xml.datatype.DatatypeConstants.EQUAL;
    }
    ...
    public int hashCode() {
        ...
        if (timezone == jaxp.xml.datatype.DatatypeConstants.FIELD_UNDEFINED) {
            timezone = 0;
        }
     ...
     *     </tr>
     *     <tr>
     *       <td>{@link jaxp.xml.datatype.DatatypeConstants#DATETIME}</td>
     *       <td>X</td>
     *       <td>X</td>
     *       <td>X</td>
     *       <td>X</td>
     ...
     *     </tr>
     *     <tr>
     *       <td>{@link jaxp.xml.datatype.DatatypeConstants#DATE}</td>
     *       <td>X</td>
     *       <td>X</td>
     *       <td>X</td>
     *       <td></td>
     ...
     *     </tr>
     *     <tr>
     *       <td>{@link jaxp.xml.datatype.DatatypeConstants#TIME}</td>
     *       <td></td>
     *       <td></td>
     *       <td></td>
     *       <td>X</td>
     ...
     *     </tr>
     *     <tr>
     *       <td>{@link jaxp.xml.datatype.DatatypeConstants#GYEARMONTH}</td>
     *       <td>X</td>
     *       <td>X</td>
     *       <td></td>
     *       <td></td>
     ...
     *     </tr>
     *     <tr>
     *       <td>{@link jaxp.xml.datatype.DatatypeConstants#GMONTHDAY}</td>
     *       <td></td>
     *       <td>X</td>
     *       <td>X</td>
     *       <td></td>
     ...
     *     </tr>
     *     <tr>
     *       <td>{@link jaxp.xml.datatype.DatatypeConstants#GYEAR}</td>
     *       <td>X</td>
     *       <td></td>
     *       <td></td>
     *       <td></td>
     ...
     *     </tr>
     *     <tr>
     *       <td>{@link jaxp.xml.datatype.DatatypeConstants#GMONTH}</td>
     *       <td></td>
     *       <td>X</td>
     *       <td></td>
     *       <td></td>
     ...
     *     </tr>
     *     <tr>
     *       <td>{@link jaxp.xml.datatype.DatatypeConstants#GDAY}</td>
     *       <td></td>
     *       <td></td>
     *       <td>X</td>
     *       <td></td>
     ...
     *   {@link jaxp.xml.datatype.DatatypeConstants#GMONTHDAY},
     *   {@link jaxp.xml.datatype.DatatypeConstants#GYEAR},
     *   {@link jaxp.xml.datatype.DatatypeConstants#GMONTH} or
     *   {@link jaxp.xml.datatype.DatatypeConstants#GDAY}.
     */
     ...
     *       <td>{@link #getMonth()} - {@link jaxp.xml.datatype.DatatypeConstants#JANUARY} + {@link GregorianCalendar#JANUARY}</td>
     *     </tr>
     *     <tr>
