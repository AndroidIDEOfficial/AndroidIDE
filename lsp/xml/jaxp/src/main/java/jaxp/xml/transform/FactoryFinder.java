 ...
 */
class FactoryFinder {
    private static final String DEFAULT_PACKAGE = "com.itsaky.org.apache.xalan.internal.";
        ...
        throws jaxp.xml.transform.TransformerFactoryConfigurationError
    {
        ...
        try {
            ...
            throw new jaxp.xml.transform.TransformerFactoryConfigurationError(x,
    ...
    private static <T> T newInstanceNoServiceLoader(Class<T> type, Class<?> providerClass) {
        ...
        try {
            ...
            throw new jaxp.xml.transform.TransformerFactoryConfigurationError(e, e.getMessage());
        ...
        throws jaxp.xml.transform.TransformerFactoryConfigurationError
    {
        ...
        if (fallbackClassName == null) {
            throw new jaxp.xml.transform.TransformerFactoryConfigurationError(null,
        ...
        throws jaxp.xml.transform.TransformerFactoryConfigurationError
    {
      try {
            ...
            final jaxp.xml.transform.TransformerFactoryConfigurationError error =
