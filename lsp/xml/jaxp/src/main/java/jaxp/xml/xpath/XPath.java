 ...
 *      <td>variables</td>
 *      <td>
 *        If the expression contains a variable reference, its value will be found through the {@link jaxp.xml.xpath.XPathVariableResolver}
 *        set with {@link #setXPathVariableResolver(jaxp.xml.xpath.XPathVariableResolver resolver)}.
 *        An {@link jaxp.xml.xpath.XPathExpressionException} is raised if the variable resolver is undefined or
 ...
 *      <td>functions</td>
 *      <td>
 *        If the expression contains a function reference, the function will be found through the {@link jaxp.xml.xpath.XPathFunctionResolver}
 *        set with {@link #setXPathFunctionResolver(jaxp.xml.xpath.XPathFunctionResolver resolver)}.
 *        An {@link jaxp.xml.xpath.XPathExpressionException} is raised if the function resolver is undefined or
 ...
 *        Valid return types are defined in {@link jaxp.xml.xpath.XPathConstants}.
...
public interface XPath {
         ...
         *
         * <p>The reset <code>XPath</code> is not guaranteed to have the same {@link jaxp.xml.xpath.XPathFunctionResolver}, {@link jaxp.xml.xpath.XPathVariableResolver}
     ...
     */
    public void setXPathVariableResolver(jaxp.xml.xpath.XPathVariableResolver resolver);
    ...
    /**
       ...
       */
    public jaxp.xml.xpath.XPathVariableResolver getXPathVariableResolver();
    ...
    /**
       ...
       * @throws NullPointerException If <code>resolver</code> is <code>null</code>.
       */
    public void setXPathFunctionResolver(jaxp.xml.xpath.XPathFunctionResolver resolver);
    ...
    /**
       ...
       */
    public jaxp.xml.xpath.XPathFunctionResolver getXPathFunctionResolver();
    ...
    /**
       ...
       * An {@link jaxp.xml.xpath.XPathExpressionException} will be thrown if the
       ...
       * @throws jaxp.xml.xpath.XPathExpressionException If <code>expression</code> cannot be compiled.
       * @throws NullPointerException If <code>expression</code> is <code>null</code>.
       */
    public XPathExpression compile(String expression)
        throws jaxp.xml.xpath.XPathExpressionException;
     ...
     *
     * <p>If <code>returnType</code> is not one of the types defined in {@link jaxp.xml.xpath.XPathConstants} (
     * {@link jaxp.xml.xpath.XPathConstants#NUMBER NUMBER},
     * {@link jaxp.xml.xpath.XPathConstants#STRING STRING},
     * {@link jaxp.xml.xpath.XPathConstants#BOOLEAN BOOLEAN},
     * {@link jaxp.xml.xpath.XPathConstants#NODE NODE} or
     * {@link jaxp.xml.xpath.XPathConstants#NODESET NODESET})
     ...
     *
     * @throws jaxp.xml.xpath.XPathExpressionException If <code>expression</code> cannot be evaluated.
     * @throws IllegalArgumentException If <code>returnType</code> is not one of the types defined in {@link jaxp.xml.xpath.XPathConstants}.
     ...
     * {@link jaxp.xml.xpath.XPathConstants#STRING}.</p>
     *
     * <p>See <a href="#XPath-evaluation">Evaluation of XPath Expressions</a> for context item evaluation,
     ...
     *
     * @throws jaxp.xml.xpath.XPathExpressionException If expression cannot be evaluated.
     * @throws IllegalArgumentException If <code>returnType</code> is not one of the types defined in {@link jaxp.xml.xpath.XPathConstants}.
