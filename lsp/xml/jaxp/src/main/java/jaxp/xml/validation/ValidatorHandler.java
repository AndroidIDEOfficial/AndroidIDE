 ...
 * the {@link Attributes} object of the
 ...
 * added to {@link Attributes} that's passed to the
...
public abstract class ValidatorHandler implements ContentHandler {
    ...
    /**
     * Obtains the {@link jaxp.xml.validation.TypeInfoProvider} implementation of this
     * {@link ValidatorHandler}.
     *
     * <p>
     * The obtained {@link jaxp.xml.validation.TypeInfoProvider} can be queried during a parse
     ...
     *      the notion of {@link TypeInfo}.
     *      Otherwise a non-null valid {@link jaxp.xml.validation.TypeInfoProvider}.
     */
