...
/**
 * Implementation of {@link jaxp.xml.xpath.XPathFactory#newInstance(String)}.
 *
...
class XPathFactoryFinder  {
    private static final String DEFAULT_PACKAGE = "com.itsaky.org.apache.xpath.internal";
     ...
     *
     * @param loader
     *      to be used to load resource and {@link jaxp.xml.xpath.XPathFactory}
    ...
    /**
     * <p>Creates a new {@link jaxp.xml.xpath.XPathFactory} object for the specified
     * object model.</p>
     *
     * @param uri
     ...
     */
    public jaxp.xml.xpath.XPathFactory newFactory(String uri) throws jaxp.xml.xpath.XPathFactoryConfigurationException {
        if (uri == null) {
            throw new NullPointerException();
        }
        jaxp.xml.xpath.XPathFactory f = _newFactory(uri);
        if (f != null) {
    ...
    /**
     * <p>Lookup a {@link jaxp.xml.xpath.XPathFactory} for the given object model.</p>
     *
     * @param uri identifies the object model.
     *
     * @return {@link jaxp.xml.xpath.XPathFactory} for the given object model.
     */
    private jaxp.xml.xpath.XPathFactory _newFactory(String uri) throws jaxp.xml.xpath.XPathFactoryConfigurationException {
        jaxp.xml.xpath.XPathFactory xpathFactory = null;
        ...
        // platform default
        if(uri.equals(jaxp.xml.xpath.XPathFactory.DEFAULT_OBJECT_MODEL_URI)) {
            debugPrintln("attempting to use the platform default W3C DOM XPath lib");
            return createInstance("com.itsaky.org.apache.xpath.internal.jaxp.XPathFactoryImpl", true);
        }
     ...
     */
    jaxp.xml.xpath.XPathFactory createInstance(String className )
            throws jaxp.xml.xpath.XPathFactoryConfigurationException
    {
        return createInstance( className, false );
    }

    jaxp.xml.xpath.XPathFactory createInstance(String className, boolean useServicesMechanism  )
            throws jaxp.xml.xpath.XPathFactoryConfigurationException
    {
        jaxp.xml.xpath.XPathFactory xPathFactory = null;
        ...
        try {
            ...
            if (xPathFactory == null) {
                xPathFactory = (jaxp.xml.xpath.XPathFactory) clazz.newInstance();
            }
     ...
     *   method if available.
     */
    private static jaxp.xml.xpath.XPathFactory newInstanceNoServiceLoader(
         Class<?> providerClass
    ) throws jaxp.xml.xpath.XPathFactoryConfigurationException {
        ...
        try {
            ...
            throw new jaxp.xml.xpath.XPathFactoryConfigurationException(e);
    ...
    private boolean isObjectModelSupportedBy(final jaxp.xml.xpath.XPathFactory factory,
     ...
     *         if none is found.
     * @throws jaxp.xml.xpath.XPathFactoryConfigurationException if a configuration error is found.
     */
    private jaxp.xml.xpath.XPathFactory findServiceProvider(final String objectModel)
            throws jaxp.xml.xpath.XPathFactoryConfigurationException {
        ...
        try {
            return AccessController.doPrivileged(new PrivilegedAction<jaxp.xml.xpath.XPathFactory>() {
                public jaxp.xml.xpath.XPathFactory run() {
                    final ServiceLoader<jaxp.xml.xpath.XPathFactory> loader =
                            ServiceLoader.load(SERVICE_CLASS);
                    for (jaxp.xml.xpath.XPathFactory factory : loader) {
    ...
    private static final Class<jaxp.xml.xpath.XPathFactory> SERVICE_CLASS = XPathFactory.class;
