...
public abstract class TypeInfoProvider {
     ...
     * of the {@link ContentHandler} that the application sets to
     ...
     *      If this method is called from other {@link ContentHandler}
     *      methods.
     * @return
     ...
     * the {@link ContentHandler} that the application sets to the
     * {@link ValidatorHandler}.</p>
     *
     * @param index
     *      The index of the attribute. The same index for
     *      the {@link Attributes} object passed to the
     ...
     * to properly implement {@link Attr#isId()}.
     *
     * <p>
     * The method may only be called by the startElement event of
     * the {@link ContentHandler} that the application sets to the
     ...
     * the DOM tree should return from the {@link Attr#getSpecified()} method.
     *
     * <p>
     * The method may only be called by the startElement event of
     * the {@link ContentHandler} that the application sets to the
