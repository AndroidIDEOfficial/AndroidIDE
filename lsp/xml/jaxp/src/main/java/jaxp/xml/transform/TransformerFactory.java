 ...
 * {@link jaxp.xml.transform.Transformer} and
 * {@link jaxp.xml.transform.Templates} objects.</p>
 *
...
public abstract class TransformerFactory {
     ...
     *
     * @throws jaxp.xml.transform.TransformerFactoryConfigurationError Thrown in case of {@linkplain
     * java.util.ServiceConfigurationError service configuration error} or if
     * the implementation is not available or cannot be instantiated.
     */
    public static TransformerFactory newInstance()
        throws jaxp.xml.transform.TransformerFactoryConfigurationError {

        return FactoryFinder.find(
            /* The default property name according to the JAXP spec */
            TransformerFactory.class,
            /* The fallback implementation class name, XSLTC */
            "com.itsaky.org.apache.xalan.internal.xsltc.trax.TransformerFactoryImpl");
    }
     ...
     *   <code>null</code>.
     *
     * @throws jaxp.xml.transform.TransformerConfigurationException Thrown if there are errors when
     ...
     */
    public abstract jaxp.xml.transform.Transformer newTransformer(jaxp.xml.transform.Source source)
     ...
     *
     * @throws jaxp.xml.transform.TransformerConfigurationException When it is not
     ...
     *
     * @throws jaxp.xml.transform.TransformerConfigurationException When parsing to
     *   construct the Templates object fails.
     */
    public abstract Templates newTemplates(jaxp.xml.transform.Source source)
        throws jaxp.xml.transform.TransformerConfigurationException;
     ...
     *
     * @throws jaxp.xml.transform.TransformerConfigurationException An <code>Exception</code>
     ...
     */
    public abstract jaxp.xml.transform.Source getAssociatedStylesheet(
        jaxp.xml.transform.Source source,
        String media,
        String title,
        String charset)
        throws jaxp.xml.transform.TransformerConfigurationException;
     ...
     * or null.
     */
    public abstract void setURIResolver(jaxp.xml.transform.URIResolver resolver);
    ...
    //======= CONFIGURATION METHODS =======
         ...
         * An {@link jaxp.xml.transform.TransformerConfigurationException} is thrown if this <code>TransformerFactory</code> or the
         ...
         *     {@link jaxp.xml.transform.ErrorListener#fatalError(TransformerException exception)}.
         *     See {@link  #setErrorListener(jaxp.xml.transform.ErrorListener listener)}.
         *   </li>
         *   <li>
         ...
         *
         * @throws jaxp.xml.transform.TransformerConfigurationException if this <code>TransformerFactory</code>
     ...
     *      {@link jaxp.xml.transform.TransformerException} will be thrown by
     *      {@link jaxp.xml.transform.Transformer#transform(jaxp.xml.transform.Source, jaxp.xml.transform.Result)}.
     *      </p>
     *      <p>
     ...
     *      {@link jaxp.xml.transform.TransformerConfigurationException} will be thrown
     *      by the {@link #newTransformer(jaxp.xml.transform.Source)} method.
     *      </p>
     *      <p>
     ...
     *      {@link jaxp.xml.transform.TransformerException} will be thrown by the
     *      {@link jaxp.xml.transform.Transformer#transform(Source, Result)} method.
     *      </p>
     *   </li>
     * </ul>
     *
     ...
     *   <code>null</code>
     */
    public abstract void setErrorListener(jaxp.xml.transform.ErrorListener listener);
