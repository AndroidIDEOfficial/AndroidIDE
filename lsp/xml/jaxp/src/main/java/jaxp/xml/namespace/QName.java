...
public class QName implements Serializable {
     ...
     *
     * <code>com.itsaky.xml.namespace.QName.useCompatibleSerialVersionUID=1.0</code>
     *
        ...
        try {
            ...
            String valueUseCompatibleSerialVersionUID = (String) AccessController.doPrivileged(
                    new PrivilegedAction() {
                        public Object run() {
                            return System.getProperty("com.itsaky.xml.namespace.QName.useCompatibleSerialVersionUID");
                        }
                    }
            );
