 ...
 *      Any Exception thrown during the instantiation process is wrapped as a {@link jaxp.xml.datatype.DatatypeConfigurationException}.
 *    </li>
 *    <li>
 ...
 *     configuration error} a {@link jaxp.xml.datatype.DatatypeConfigurationException}
 *     will be thrown.
 *    </li>
 *    <li>
...
public abstract class DatatypeFactory {
    ...
    public static final String DATATYPEFACTORY_IMPLEMENTATION_CLASS =
        ...
        new String("com.itsaky.org.apache.xerces.internal.jaxp.datatype.DatatypeFactoryImpl");
     ...
     *
     * @throws jaxp.xml.datatype.DatatypeConfigurationException If the implementation is not
     *   available or cannot be instantiated.
     *
     * @see #newInstance(String factoryClassName, ClassLoader classLoader)
     */
    public static DatatypeFactory newInstance()
            throws jaxp.xml.datatype.DatatypeConfigurationException {
     ...
     * @return New instance of a <code>DatatypeFactory</code>
     *
     * @throws jaxp.xml.datatype.DatatypeConfigurationException if <code>factoryClassName</code> is <code>null</code>, or
     ...
     * </blockquote>
     * <p>All six values are set and available from the created {@link jaxp.xml.datatype.Duration}</p>
     *
     ...
     */
    public abstract jaxp.xml.datatype.Duration newDuration(final String lexicalRepresentation);
     ...
     * and are available using the <code>get</code> methods of  the created {@link jaxp.xml.datatype.Duration}.
     ...
     *   </li>
     *   <li>{@link jaxp.xml.datatype.XMLGregorianCalendar}  Date/Time Datatype Field Mapping Between XML Schema 1.0 and Java Representation</li>
     * </ul>
     *
     ...
     * so the result of {@link jaxp.xml.datatype.Duration#getMonths()} and {@link jaxp.xml.datatype.Duration#getDays()} can be influenced.</p>
     *
     ...
     */
    public abstract jaxp.xml.datatype.Duration newDuration(final long durationInMilliSeconds);
     ...
     * @throws UnsupportedOperationException If implementation cannot support requested values.
     */
    public abstract jaxp.xml.datatype.Duration newDuration(
     ...
     * specifying the <code>Duration</code> as isPositive, years, months, days, hours, minutes, seconds.</p>
     *
     * <p>A {@link jaxp.xml.datatype.DatatypeConstants#FIELD_UNDEFINED} value indicates that field is not set.</p>
     *
     * @param isPositive Set to <code>false</code> to create a negative duration. When the length
     *   of the duration is zero, this parameter will be ignored.
     * @param years of this <code>Duration</code>
     ...
     *   BigDecimal seconds)
     */
    public jaxp.xml.datatype.Duration newDuration(
            final boolean isPositive,
            final int years,
            final int months,
            final int days,
            ...
            BigInteger realYears = (years != jaxp.xml.datatype.DatatypeConstants.FIELD_UNDEFINED) ? BigInteger.valueOf((long) years) : null;

            // months may not be set
            BigInteger realMonths = (months != jaxp.xml.datatype.DatatypeConstants.FIELD_UNDEFINED) ? BigInteger.valueOf((long) months) : null;

            // days may not be set
            BigInteger realDays = (days != jaxp.xml.datatype.DatatypeConstants.FIELD_UNDEFINED) ? BigInteger.valueOf((long) days) : null;

            // hours may not be set
            BigInteger realHours = (hours != jaxp.xml.datatype.DatatypeConstants.FIELD_UNDEFINED) ? BigInteger.valueOf((long) hours) : null;

            // minutes may not be set
            BigInteger realMinutes = (minutes != jaxp.xml.datatype.DatatypeConstants.FIELD_UNDEFINED) ? BigInteger.valueOf((long) minutes) : null;

            // seconds may not be set
            BigDecimal realSeconds = (seconds != jaxp.xml.datatype.DatatypeConstants.FIELD_UNDEFINED) ? BigDecimal.valueOf((long) seconds) : null;
     ...
     *
     * <p>All four values are set and available from the created {@link jaxp.xml.datatype.Duration}</p>
     *
     * <p>The XML Schema specification states that values can be of an arbitrary size.
     * Implementations may chose not to or be incapable of supporting arbitrarily large and/or small values.
     * An {@link UnsupportedOperationException} will be thrown with a message indicating implementation limits
     ...
     * @throws NullPointerException If <code>lexicalRepresentation</code> is <code>null</code>.
     */
    public jaxp.xml.datatype.Duration newDurationDayTime(final String lexicalRepresentation) {
     ...
     * This is important as there are variations in the Gregorian Calendar,
     * e.g. leap years have different days in the month = {@link java.util.Calendar#FEBRUARY}
     * so the result of {@link jaxp.xml.datatype.Duration#getDays()} can be influenced.</p>
     *
     ...
     */
    public jaxp.xml.datatype.Duration newDurationDayTime(final long durationInMilliseconds) {
     ...
     * @throws UnsupportedOperationException If implementation cannot support requested values.
     */
    public jaxp.xml.datatype.Duration newDurationDayTime(
            final boolean isPositive,
     ...
     *
     * <p>Both values are set and available from the created {@link jaxp.xml.datatype.Duration}</p>
     *
     * <p>The XML Schema specification states that values can be of an arbitrary size.
     * Implementations may chose not to or be incapable of supporting arbitrarily large and/or small values.
     * An {@link UnsupportedOperationException} will be thrown with a message indicating implementation limits
     ...
     * @throws NullPointerException If <code>lexicalRepresentation</code> is <code>null</code>.
     */
    public jaxp.xml.datatype.Duration newDurationYearMonth(
     ...
     * This is important as there are variations in the Gregorian Calendar,
     * e.g. leap years have different days in the month = {@link java.util.Calendar#FEBRUARY}
     * so the result of {@link jaxp.xml.datatype.Duration#getMonths()} can be influenced.</p>
     *
    ...
    public jaxp.xml.datatype.Duration newDurationYearMonth(
        ...
        jaxp.xml.datatype.Duration fullDuration = newDuration(durationInMilliseconds);
        boolean isPositive = (fullDuration.getSign() == -1) ? false : true;
        BigInteger years =
            (BigInteger) fullDuration.getField(jaxp.xml.datatype.DatatypeConstants.YEARS);
        if (years == null) { years = BigInteger.ZERO; }
        BigInteger months =
            (BigInteger) fullDuration.getField(jaxp.xml.datatype.DatatypeConstants.MONTHS);
     ...
     *
     * <p>All date/time datatype fields set to {@link jaxp.xml.datatype.DatatypeConstants#FIELD_UNDEFINED} or null.</p>
     *
     * @return New <code>XMLGregorianCalendar</code> with all date/time datatype fields set to
     *   {@link jaxp.xml.datatype.DatatypeConstants#FIELD_UNDEFINED} or null.
     */
    public abstract jaxp.xml.datatype.XMLGregorianCalendar newXMLGregorianCalendar();
     ...
     * @throws NullPointerException If <code>lexicalRepresentation</code> is <code>null</code>.
     */
    public abstract jaxp.xml.datatype.XMLGregorianCalendar newXMLGregorianCalendar(final String lexicalRepresentation);
     ...
     *          {@link GregorianCalendar} to an {@link jaxp.xml.datatype.XMLGregorianCalendar}
     *       </th>
     *     </tr>
     *     <tr>
     ...
     *       <td>{@link jaxp.xml.datatype.XMLGregorianCalendar#setYear(int year)}</td>
     *     </tr>
     *     <tr>
     *       <td><code>MONTH + 1</code></td>
     *       <td>{@link jaxp.xml.datatype.XMLGregorianCalendar#setMonth(int month)}</td>
     *     </tr>
     *     <tr>
     *       <td><code>DAY_OF_MONTH</code></td>
     *       <td>{@link jaxp.xml.datatype.XMLGregorianCalendar#setDay(int day)}</td>
     *     </tr>
     *     <tr>
     *       <td><code>HOUR_OF_DAY, MINUTE, SECOND, MILLISECOND</code></td>
     *       <td>{@link jaxp.xml.datatype.XMLGregorianCalendar#setTime(int hour, int minute, int second, BigDecimal fractional)}</td>
     *     </tr>
     *     <tr>
     *       <td>
     ...
     *         <em>(in minutes)</em>
     *       </td>
     *       <td>{@link jaxp.xml.datatype.XMLGregorianCalendar#setTimezone(int offset)}<sup><em>*</em></sup>
     *       </td>
     *     </tr>
     *   </tbody>
     * </table>
     ...
     */
    public abstract jaxp.xml.datatype.XMLGregorianCalendar newXMLGregorianCalendar(final GregorianCalendar cal);
     ...
     *   as determined by the Date/Time Data Mapping table in {@link jaxp.xml.datatype.XMLGregorianCalendar}
     *   or if the composite values constitute an invalid <code>XMLGregorianCalendar</code> instance
     *   as determined by {@link jaxp.xml.datatype.XMLGregorianCalendar#isValid()}.
     */
    public abstract jaxp.xml.datatype.XMLGregorianCalendar newXMLGregorianCalendar(
            final BigInteger year,
            final int month,
     ...
     *   as determined by {@link jaxp.xml.datatype.XMLGregorianCalendar#isValid()}.
     */
    public jaxp.xml.datatype.XMLGregorianCalendar newXMLGregorianCalendar(
            final int year,
            final int month,
            final int day,
            final int hour,
            ...
            BigInteger realYear = (year != jaxp.xml.datatype.DatatypeConstants.FIELD_UNDEFINED) ? BigInteger.valueOf((long) year) : null;

            // millisecond may be undefined
            // millisecond must be >= 0 millisecond <= 1000
            BigDecimal realMillisecond = null; // undefined value
            if (millisecond != jaxp.xml.datatype.DatatypeConstants.FIELD_UNDEFINED) {
     ...
     * {@link jaxp.xml.datatype.DatatypeConstants#FIELD_UNDEFINED}.</p>
     *
     * <p>A {@link jaxp.xml.datatype.DatatypeConstants#FIELD_UNDEFINED} value indicates that field is not set.</p>
     *
     * @param year of <code>XMLGregorianCalendar</code> to be created.
     * @param month of <code>XMLGregorianCalendar</code> to be created.
     * @param day of <code>XMLGregorianCalendar</code> to be created.
     * @param timezone offset in minutes. {@link jaxp.xml.datatype.DatatypeConstants#FIELD_UNDEFINED} indicates optional field is not set.
     *
     * @return <code>XMLGregorianCalendar</code> created from parameter values.
     *
     * @see jaxp.xml.datatype.DatatypeConstants#FIELD_UNDEFINED
     *
     * @throws IllegalArgumentException If any individual parameter's value is outside the maximum value constraint for the field
     *   as determined by the Date/Time Data Mapping table in {@link jaxp.xml.datatype.XMLGregorianCalendar}
     *   or if the composite values constitute an invalid <code>XMLGregorianCalendar</code> instance
     *   as determined by {@link jaxp.xml.datatype.XMLGregorianCalendar#isValid()}.
     */
    public jaxp.xml.datatype.XMLGregorianCalendar newXMLGregorianCalendarDate(
            final int year,
            final int month,
            final int day,
            final int timezone) {
            ...
            return newXMLGregorianCalendar(
                    ...
                    month,
                    day,
                    jaxp.xml.datatype.DatatypeConstants.FIELD_UNDEFINED, // hour
                    jaxp.xml.datatype.DatatypeConstants.FIELD_UNDEFINED, // minute
                    jaxp.xml.datatype.DatatypeConstants.FIELD_UNDEFINED, // second
                    jaxp.xml.datatype.DatatypeConstants.FIELD_UNDEFINED, // millisecond
                    timezone);
            }
     ...
     * @see jaxp.xml.datatype.DatatypeConstants#FIELD_UNDEFINED
     */
    public jaxp.xml.datatype.XMLGregorianCalendar newXMLGregorianCalendarTime(
            final int hours,
            final int minutes,
            final int seconds,
            final int timezone) {
            ...
            return newXMLGregorianCalendar(
                    jaxp.xml.datatype.DatatypeConstants.FIELD_UNDEFINED, // Year
                    jaxp.xml.datatype.DatatypeConstants.FIELD_UNDEFINED, // Month
                    jaxp.xml.datatype.DatatypeConstants.FIELD_UNDEFINED, // Day
                    hours,
                    minutes,
                    seconds,
                    jaxp.xml.datatype.DatatypeConstants.FIELD_UNDEFINED, //Millisecond
