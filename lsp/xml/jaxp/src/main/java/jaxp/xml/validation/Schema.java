 ...
 *
 * <p>
 * A {@link Schema} object is usually created from {@link jaxp.xml.validation.SchemaFactory}.
 *
 * <p>
 * Two kinds of validators can be created from a {@link Schema} object.
 * One is {@link jaxp.xml.validation.Validator}, which provides highly-level validation
 * operations that cover typical use cases. The other is
 * {@link jaxp.xml.validation.ValidatorHandler}, which works on top of SAX for better
 * modularity.
 *
 * <p>
...
public abstract class Schema {
    ...
    /**
     * Creates a new {@link jaxp.xml.validation.Validator} for this {@link Schema}.
     *
     ...
     * {@link jaxp.xml.validation.SchemaFactory} that created this {@link Schema} are also
     * set on the {@link jaxp.xml.validation.Validator} constructed.</p>
     *
     * @return
    ...
    /**
     * Creates a new {@link jaxp.xml.validation.ValidatorHandler} for this {@link Schema}.
     *
     * <p>Implementors should assure that the properties set on the
     * {@link SchemaFactory} that created this {@link Schema} are also
     * set on the {@link jaxp.xml.validation.ValidatorHandler} constructed.</p>
     *
     * @return
     *      Always return a non-null valid object.
     */
