...
public abstract class DocumentBuilderFactory {
     ...
     *
     * <p> If you have problems loading {@link jaxp.xml.parsers.DocumentBuilder}s, try:</p>
     * <pre>
     ...
     *
     * @throws jaxp.xml.parsers.FactoryConfigurationError in case of {@linkplain
     * java.util.ServiceConfigurationError service configuration error} or if
     * the implementation is not available or cannot be instantiated.
     */
    public static DocumentBuilderFactory newInstance() {
        return FactoryFinder.find(jaxp.xml.parsers.DocumentBuilderFactory.class,
                "com.itsaky.org.apache.xerces.internal.jaxp.DocumentBuilderFactoryImpl");
...
//                "com.itsaky.org.apache.xerces.internal.jaxp.DocumentBuilderFactoryImpl"));
    ...
    /**
     * Creates a new instance of a {@link jaxp.xml.parsers.DocumentBuilder}
     * using the currently configured parameters.
     *
     * @return A new instance of a DocumentBuilder.
     *
     * @throws jaxp.xml.parsers.ParserConfigurationException if a DocumentBuilder
     *   cannot be created which satisfies the configuration requested.
     */

    public abstract jaxp.xml.parsers.DocumentBuilder newDocumentBuilder()
        throws jaxp.xml.parsers.ParserConfigurationException;
     ...
     *      {@link SAXException} will be thrown by the parse methods defined by
     *      {@link jaxp.xml.parsers.DocumentBuilder}.
     *      </p>
     *      <p>
     ...
     * A {@link jaxp.xml.parsers.ParserConfigurationException} is thrown if this <code>DocumentBuilderFactory</code> or the
     ...
     *     See {@link  DocumentBuilder#setErrorHandler(ErrorHandler errorHandler)}.
     *   </li>
     *   <li>
     ...
     *
     * @throws jaxp.xml.parsers.ParserConfigurationException if this <code>DocumentBuilderFactory</code> or the <code>DocumentBuilder</code>s
     ...
     * Feature names are fully qualified {@link java.net.URI}s.
     * Implementations may define their own features.
     * An {@link jaxp.xml.parsers.ParserConfigurationException} is thrown if this <code>DocumentBuilderFactory</code> or the
     * <code>DocumentBuilder</code>s it creates cannot support the feature.
     ...
     *
     * @throws jaxp.xml.parsers.ParserConfigurationException if this <code>DocumentBuilderFactory</code>
     ...
     * to report them to the user-specified {@link ErrorHandler}
     * (or if the error handler is not set, ignore them or throw them), just
     * like any other errors found by the parser itself.
     * In other words, if the user-specified {@link ErrorHandler}
