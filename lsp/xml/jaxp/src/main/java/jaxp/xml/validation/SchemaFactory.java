...
/**
 * Factory that creates {@link jaxp.xml.validation.Schema} objects&#x2E; Entry-point to
 * the validation API.
 *
 * <p>
...
public abstract class SchemaFactory {
     ...
     * {@link jaxp.xml.validation.Schema}s created by this factory, and by extension,
     * {@link jaxp.xml.validation.Validator}s and {@link jaxp.xml.validation.ValidatorHandler}s created by
     * those {@link jaxp.xml.validation.Schema}s.
     * </p>
     *
     * <p>Implementors and developers should pay particular attention
     * to how the special {@link jaxp.xml.validation.Schema} object returned by {@link
     ...
     *      of this property, {@link SAXException} will be thrown by the
     *      {@link jaxp.xml.validation.Validator#validate(Source)} or
     *      {@link jaxp.xml.validation.Validator#validate(Source, Result)} method.</p>
     *
     ...
     *
     * <p>
     * Applications can call this method even during a {@link jaxp.xml.validation.Schema}
     * is being parsed.
     *
     * <p>
     ...
     * inherited to {@link jaxp.xml.validation.Schema}s, {@link jaxp.xml.validation.Validator}s, or
     * {@link jaxp.xml.validation.ValidatorHandler}s that are created from this {@link SchemaFactory}.
     *
     ...
     *     public {@link LSInput} resolveResource(
     ...
     * When a new {@link SchemaFactory} object is created, initially
     * this field is set to null.  This field will <em>NOT</em> be
     * inherited to {@link jaxp.xml.validation.Schema}s, {@link Validator}s, or
     ...
     */
    public jaxp.xml.validation.Schema newSchema(Source schema) throws SAXException {
     ...
     * @throws NullPointerException if <code>schema</code> is null.
     */
    public jaxp.xml.validation.Schema newSchema(File schema) throws SAXException {
     ...
     * @throws NullPointerException if <code>schema</code> is null.
     */
    public jaxp.xml.validation.Schema newSchema(URL schema) throws SAXException {
     ...
     *
     * @return
     *      Always return a non-null valid {@link jaxp.xml.validation.Schema} object.
     *      Note that when an error has been reported, there is no
     *      guarantee that the returned {@link jaxp.xml.validation.Schema} object is
     *      meaningful.
     *
     * @throws SAXException
     ...
     */
    public abstract jaxp.xml.validation.Schema newSchema(Source[] schemas) throws SAXException;

    /**
     * Creates a special {@link jaxp.xml.validation.Schema} object.
     *
     * <p>The exact semantics of the returned {@link jaxp.xml.validation.Schema} object
     ...
     * processed by this special {@link jaxp.xml.validation.Schema}.
     ...
     * <h2>W3C XML Schema 1.0</h2>
     * <p>
     * For XML Schema, this method creates a {@link jaxp.xml.validation.Schema} object that
     * performs validation by using location hints specified in documents.
     *
     * <p>
     * The returned {@link jaxp.xml.validation.Schema} object assumes that if documents
     ...
     *
     * @return
     *      Always return non-null valid {@link jaxp.xml.validation.Schema} object.
     *
     * @throws UnsupportedOperationException
