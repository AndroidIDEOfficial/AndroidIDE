...
class FactoryFinder {
    ...
    static <T> T newInstance(Class<T> type, String className, ClassLoader cl,
                             boolean doFallback)
        throws jaxp.xml.parsers.FactoryConfigurationError
    {
        ...
        throws jaxp.xml.parsers.FactoryConfigurationError
    {
        ...
        try {
            ...
            throw new jaxp.xml.parsers.FactoryConfigurationError(x,
        ...
        throws jaxp.xml.parsers.FactoryConfigurationError
    {
        ...
        if (fallbackClassName == null) {
            throw new jaxp.xml.parsers.FactoryConfigurationError(
    ...
    private static <T> T findServiceProvider(final Class<T> type) {
        try {
            ...
            final jaxp.xml.parsers.FactoryConfigurationError error =
