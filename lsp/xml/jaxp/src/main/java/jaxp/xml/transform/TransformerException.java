...
public class TransformerException extends Exception {
    ...
    jaxp.xml.transform.SourceLocator locator;
     ...
     */
    public jaxp.xml.transform.SourceLocator getLocator() {
        return locator;
    }
     ...
     */
    public void setLocator(jaxp.xml.transform.SourceLocator location) {
        locator = location;
    }
     ...
     */
    public TransformerException(String message, jaxp.xml.transform.SourceLocator locator) {
