 ...
 * {@link jaxp.xml.xpath.XPath} objects.</p>
 *
...
public abstract class XPathFactory {
    ...
    public static XPathFactory newInstance() {
        ...
        } catch (jaxp.xml.xpath.XPathFactoryConfigurationException xpathFactoryConfigurationException) {
    ...
    *     {@link jaxp.xml.xpath.XPathFactoryConfigurationException} will be thrown.
    *   </li>
    *   <li>
    ...
    * @return Instance of an <code>XPathFactory</code>.
    *
    * @throws jaxp.xml.xpath.XPathFactoryConfigurationException If the specified object model
    ...
    */
    public static XPathFactory newInstance(final String uri)
        ...
        if (xpathFactory == null) {
            throw new jaxp.xml.xpath.XPathFactoryConfigurationException(
    ...
    public static XPathFactory newInstance(String uri, String factoryClassName, ClassLoader classLoader)
        ...
        if (f.isObjectModelSupported(uri)) {
            ...
            throw new jaxp.xml.xpath.XPathFactoryConfigurationException("Factory "
     ...
     * An {@link jaxp.xml.xpath.XPathFactoryConfigurationException} is thrown if this
     ...
     * Under these conditions, the implementation must not call the {@link jaxp.xml.xpath.XPathFunctionResolver}
     ...
     *
     * @throws jaxp.xml.xpath.XPathFactoryConfigurationException if this <code>XPathFactory</code> or the <code>XPath</code>s
     ...
     *
     * @throws jaxp.xml.xpath.XPathFactoryConfigurationException if this
     *   <code>XPathFactory</code> or the <code>XPath</code>s
     *   it creates cannot support this feature.
     * @throws NullPointerException if <code>name</code> is <code>null</code>.
     */
