...
public class VariableStack implements Cloneable
{
            ...
            throws jaxp.xml.transform.TransformerException
  {
    ...
    // J2SE does not support Xalan interpretive
        /*
    com.itsaky.org.apache.xml.internal.utils.PrefixResolver prefixResolver =
    ...
    if (prefixResolver instanceof com.itsaky.org.apache.xalan.internal.templates.ElemTemplateElement)
    {

      com.itsaky.org.apache.xalan.internal.templates.ElemVariable vvar;

      com.itsaky.org.apache.xalan.internal.templates.ElemTemplateElement prev =
        (com.itsaky.org.apache.xalan.internal.templates.ElemTemplateElement) prefixResolver;

      if (!(prev instanceof com.itsaky.org.apache.xalan.internal.templates.Stylesheet))
      {
        while ( !(prev.getParentNode() instanceof com.itsaky.org.apache.xalan.internal.templates.Stylesheet) )
        {
    ...
    */
    ...
    throw new jaxp.xml.transform.TransformerException(XSLMessages.createXPATHMessage(XPATHErrorResources.ER_VAR_NOT_RESOLVABLE, new Object[]{qname.toString()})); //"Variable not resolvable: " + qname);
  }
}  // end VariableStack
