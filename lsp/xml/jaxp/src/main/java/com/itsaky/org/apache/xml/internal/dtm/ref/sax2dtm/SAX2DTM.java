 ...
 */
package com.itsaky.org.apache.xml.internal.dtm.ref.sax2dtm;
...
import com.itsaky.org.apache.xml.internal.dtm.DTMManager;
import com.itsaky.org.apache.xml.internal.dtm.ref.DTMDefaultBaseIterators;
import com.itsaky.org.apache.xml.internal.dtm.ref.DTMManagerDefault;
import com.itsaky.org.apache.xml.internal.dtm.ref.DTMStringPool;
import com.itsaky.org.apache.xml.internal.dtm.ref.DTMTreeWalker;
import com.itsaky.org.apache.xml.internal.dtm.ref.IncrementalSAXSource;
import com.itsaky.org.apache.xml.internal.dtm.ref.NodeLocator;
import com.itsaky.org.apache.xml.internal.utils.StringVector;
import com.itsaky.org.apache.xml.internal.utils.IntVector;
import com.itsaky.org.apache.xml.internal.utils.FastStringBuffer;
import com.itsaky.org.apache.xml.internal.utils.IntStack;
import com.itsaky.org.apache.xml.internal.utils.SuballocatedIntVector;
import com.itsaky.org.apache.xml.internal.utils.SystemIDResolver;
import com.itsaky.org.apache.xml.internal.utils.WrappedRuntimeException;
import com.itsaky.org.apache.xml.internal.utils.XMLString;
import com.itsaky.org.apache.xml.internal.utils.XMLStringFactory;
import com.itsaky.org.apache.xml.internal.res.XMLErrorResources;
import com.itsaky.org.apache.xml.internal.res.XMLMessages;
import com.itsaky.org.apache.xml.internal.dtm.DTM;
import com.itsaky.org.apache.xml.internal.dtm.DTMWSFilter;
...
public class SAX2DTM extends DTMDefaultBaseIterators
        implements jaxp.sax.EntityResolver, jaxp.sax.DTDHandler, jaxp.sax.ContentHandler, jaxp.sax.ErrorHandler,
        jaxp.sax.ext.DeclHandler, jaxp.sax.ext.LexicalHandler
{
  ...
  transient protected jaxp.sax.Locator m_locator = null;
                 ...
                 boolean newNameTable)
  {
    ...
    // m_useSourceLocationProperty=com.itsaky.org.apache.xalan.internal.processor.TransformerFactoryImpl.m_source_location;
   ...
   */
  public jaxp.sax.ContentHandler getContentHandler()
  {

    if (m_incrementalSAXSource.getClass()
        .getName().equals("com.itsaky.org.apache.xml.internaldtm.ref.IncrementalSAXSource_Filter"))
      return (jaxp.sax.ContentHandler) m_incrementalSAXSource;
    else
      return this;
  }
   ...
   * it can be statically referenced using instanceof (CR 6537912).
   */
  public jaxp.sax.ext.LexicalHandler getLexicalHandler()
  {

    if (m_incrementalSAXSource.getClass()
        .getName().equals("com.itsaky.org.apache.xml.internaldtm.ref.IncrementalSAXSource_Filter"))
      return (jaxp.sax.ext.LexicalHandler) m_incrementalSAXSource;
    else
      return this;
  }
   ...
   */
  public jaxp.sax.EntityResolver getEntityResolver()
  {
    return this;
  }
   ...
   */
  public jaxp.sax.DTDHandler getDTDHandler()
  {
    return this;
  }
   ...
   */
  public jaxp.sax.ErrorHandler getErrorHandler()
  {
    return this;
  }
   ...
   */
  public void dispatchCharactersEvents(int nodeHandle, jaxp.sax.ContentHandler ch,
                                       boolean normalize)
          throws jaxp.sax.SAXException
  {
  ...
  public String getDocumentTypeDeclarationSystemIdentifier()
  {
    ...
    /** @todo: implement this com.itsaky.org.apache.xml.internal.dtm.DTMDefaultBase abstract method */
   ...
   * @throws jaxp.sax.SAXException
   */
  public void dispatchToEvents(int nodeHandle, jaxp.sax.ContentHandler ch)
          throws jaxp.sax.SAXException
  {

    DTMTreeWalker treeWalker = m_walker;
    jaxp.sax.ContentHandler prevCH = treeWalker.getcontentHandler();
...
//    }
   ...
   *         default behaviour.
   * @throws jaxp.sax.SAXException Any SAX exception, possibly
   *            wrapping another exception.
   * @see jaxp.sax.EntityResolver#resolveEntity
   *
   * @throws jaxp.sax.SAXException
   */
   ...
   * @throws jaxp.sax.SAXException Any SAX exception, possibly
   *            wrapping another exception.
   * @see jaxp.sax.DTDHandler#notationDecl
   *
   * @throws jaxp.sax.SAXException
   */
   ...
   * @throws jaxp.sax.SAXException Any SAX exception, possibly
   *            wrapping another exception.
   * @see jaxp.sax.DTDHandler#unparsedEntityDecl
   *
   * @throws jaxp.sax.SAXException
   */
            ...
            throws jaxp.sax.SAXException
  {
    ...
    {
      throw new jaxp.sax.SAXException (e);
    }
   ...
   * @see jaxp.sax.ContentHandler#setDocumentLocator
   * @see jaxp.sax.Locator
   */
   ...
   * @throws jaxp.sax.SAXException Any SAX exception, possibly
   *            wrapping another exception.
   * @see jaxp.sax.ContentHandler#startDocument
   */
  public void startDocument() throws jaxp.sax.SAXException
  {
    if (DEBUG)
   ...
   * @throws jaxp.sax.SAXException Any SAX exception, possibly
   *            wrapping another exception.
   * @see jaxp.sax.ContentHandler#endDocument
   */
  public void endDocument() throws jaxp.sax.SAXException
  {
    if (DEBUG)
   ...
   * @throws jaxp.sax.SAXException Any SAX exception, possibly
   *            wrapping another exception.
   * @see jaxp.sax.ContentHandler#startPrefixMapping
   */
   ...
   * @throws jaxp.sax.SAXException Any SAX exception, possibly
   *            wrapping another exception.
   * @see jaxp.sax.ContentHandler#endPrefixMapping
   */
  public void endPrefixMapping(String prefix) throws jaxp.sax.SAXException
  {
    if (DEBUG)
   ...
   * @throws jaxp.sax.SAXException Any SAX exception, possibly
   *            wrapping another exception.
   * @see jaxp.sax.ContentHandler#startElement
   */
  public void startElement(
          String uri, String localName, String qName, jaxp.sax.Attributes attributes)
            throws jaxp.sax.SAXException
  {
   if (DEBUG)
         {
   ...
   * @throws jaxp.sax.SAXException Any SAX exception, possibly
   *            wrapping another exception.
   * @see jaxp.sax.ContentHandler#endElement
   */
   ...
   * @throws jaxp.sax.SAXException Any SAX exception, possibly
   *            wrapping another exception.
   * @see jaxp.sax.ContentHandler#characters
   */
  public void characters(char ch[], int start, int length) throws jaxp.sax.SAXException
  {
   ...
   * @throws jaxp.sax.SAXException Any SAX exception, possibly
   *            wrapping another exception.
   * @see jaxp.sax.ContentHandler#ignorableWhitespace
   */
   ...
   * @throws jaxp.sax.SAXException Any SAX exception, possibly
   *            wrapping another exception.
   * @see jaxp.sax.ContentHandler#processingInstruction
   */
   ...
   * @see jaxp.sax.ContentHandler#processingInstruction
   */
  public void skippedEntity(String name) throws jaxp.sax.SAXException
  {
   ...
   * @throws jaxp.sax.SAXException Any SAX exception, possibly
   *            wrapping another exception.
   * @see jaxp.sax.ErrorHandler#warning
   * @see jaxp.sax.SAXParseException
   */
  public void warning(jaxp.sax.SAXParseException e) throws jaxp.sax.SAXException
  {
   ...
   * @see jaxp.sax.SAXParseException
   */
  public void error(jaxp.sax.SAXParseException e) throws jaxp.sax.SAXException
  {
    throw e;
  }
   ...
   * @throws jaxp.sax.SAXException Any SAX exception, possibly
   *            wrapping another exception.
   * @see jaxp.sax.ErrorHandler#fatalError
   * @see jaxp.sax.SAXParseException
   */
  public void fatalError(jaxp.sax.SAXParseException e) throws jaxp.sax.SAXException
  {
    throw e;
  }
   ...
   * @throws jaxp.sax.SAXException The application may raise an exception.
   */
  public void elementDecl(String name, String model) throws jaxp.sax.SAXException
  {
  ...
  public void externalEntityDecl(
          String name, String publicId, String systemId) throws jaxp.sax.SAXException
  {
   ...
   *        external DTD subset, or null if none was declared.
   * @throws jaxp.sax.SAXException The application may raise an
   *            exception.
   * @see #endDTD
   * @see #startEntity
   */
   ...
   * @see #startDTD
   */
  public void endDTD() throws jaxp.sax.SAXException
  {
   ...
   * {@link jaxp.sax.ContentHandler#skippedEntity skippedEntity}
   ...
   * @throws jaxp.sax.SAXException The application may raise an exception.
   * @see #endEntity
   * @see jaxp.sax.ext.DeclHandler#internalEntityDecl
   * @see jaxp.sax.ext.DeclHandler#externalEntityDecl
   */
  public void startEntity(String name) throws jaxp.sax.SAXException
  {
   ...
   * @see #startEntity
   */
  public void endEntity(String name) throws jaxp.sax.SAXException
  {
   ...
   * the regular {@link jaxp.sax.ContentHandler#characters
   * characters} event.</p>
   *
   * @throws jaxp.sax.SAXException The application may raise an exception.
   * @see #endCDATA
   */
  public void startCDATA() throws jaxp.sax.SAXException
  {
   ...
   * @see #startCDATA
   */
  public void endCDATA() throws jaxp.sax.SAXException
  {
   ...
   * @throws jaxp.sax.SAXException The application may raise an exception.
   */
  public void comment(char ch[], int start, int length) throws jaxp.sax.SAXException
  {
