 ...
 */
package com.itsaky.org.apache.xml.internal.dtm.ref;

import com.itsaky.org.apache.xalan.internal.utils.FactoryImpl;
...
import com.itsaky.org.apache.xml.internal.dtm.DTMException;
...
import com.itsaky.org.apache.xml.internal.dtm.ref.dom2dtm.DOM2DTM;
import com.itsaky.org.apache.xml.internal.dtm.ref.sax2dtm.SAX2DTM;
import com.itsaky.org.apache.xml.internal.dtm.ref.sax2dtm.SAX2RTFDTM;
...
import com.itsaky.org.apache.xml.internal.utils.XMLReaderManager;
import com.itsaky.org.apache.xml.internal.utils.XMLStringFactory;

import com.itsaky.org.apache.xml.internal.dtm.ref.dom2dtm.DOM2DTMdefaultNamespaceDeclarationNode;
...
public class DTMManagerDefault extends DTMManager
{
        ...
        try {
          ...
          **************************************************************/
          ...
          boolean haveXercesParser =
                     ...
                     && (reader.getClass()
                               .getName()
                               .equals("com.itsaky.org.apache.xerces.internal.parsers.SAXParser") );
          ...
          if (m_incremental && incremental
            ...
            if (haveXercesParser) {
              ...
              try {
                coParser =(IncrementalSAXSource)
                  Class.forName("com.itsaky.org.apache.xml.internal.dtm.ref.IncrementalSAXSource_Xerces").newInstance();
              }  catch( Exception ex ) {
                ex.printStackTrace();
                coParser=null;
              }
            ...
            if (JKESS_XNI_EXPERIMENT && m_incremental &&
                ...
                com.itsaky.org.apache.xerces.internal.xni.parser.XMLPullParserConfiguration xpc=
  ...
  synchronized public int getDTMHandleFromNode(Node node)
  {
    ...
    else
    {
      ...
      Node root = node;
      Node p = (root.getNodeType() == Node.ATTRIBUTE_NODE) ? ((Attr)root).getOwnerElement() : root.getParentNode();
      for (; p != null; p = p.getParentNode())
      {
        root = p;
      }

      DOM2DTM dtm = (DOM2DTM) getDTM(new jaxp.xml.transform.dom.DOMSource(root),
                                                    ...
                                                    boolean entityReferenceExpansion)
  {
    ...
    /** @todo: implement this com.itsaky.org.apache.xml.internal.dtm.DTMManager abstract method */
    return null;
  }
