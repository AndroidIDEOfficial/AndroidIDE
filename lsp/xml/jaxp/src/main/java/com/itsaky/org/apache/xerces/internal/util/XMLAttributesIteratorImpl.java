 ...
 * Attribute object of type jaxp.xml.stream.Attribute internally. It would avoid the need of creating
 * new jaxp.xml.stream.Attribute object at the later stage.
 *
...
public class XMLAttributesIteratorImpl extends XMLAttributesImpl implements Iterator {
    ...
    public Object next() {
        if(hasNext()){
            // should this be of type jaxp.xml.stream.Attribute ?
     ...
     */
    /*
    class AttributeImpl extends com.itsaky.org.apache.xerces.internal.util.XMLAttributesImpl.Attribute implements jaxp.xml.stream.events.Attribute{
