...
public class TransformerHandlerImpl implements TransformerHandler, DeclHandler {
    ...
    /**
     * Implements jaxp.xml.transform.sax.TransformerHandler.getSystemId()
    ...
    /**
     * Implements jaxp.xml.transform.sax.TransformerHandler.setSystemId()
     * Get the base ID (URI or system ID) from where relative URLs will be
     * resolved.
    ...
    /**
     * Implements jaxp.xml.transform.sax.TransformerHandler.getTransformer()
    ...
    /**
     * Implements jaxp.xml.transform.sax.TransformerHandler.setResult()
