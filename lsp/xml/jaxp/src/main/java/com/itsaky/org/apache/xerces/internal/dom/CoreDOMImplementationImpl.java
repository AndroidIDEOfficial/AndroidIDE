...
import com.itsaky.org.apache.xerces.internal.parsers.DOMParserImpl;
import com.itsaky.org.apache.xerces.internal.parsers.DTDConfiguration;
import com.itsaky.org.apache.xerces.internal.parsers.XIncludeAwareParserConfiguration;
...
import com.itsaky.org.apache.xml.internal.serialize.DOMSerializerImpl;
...
import jaxp.w3c.dom.ls.DOMImplementationLS;
...
public class CoreDOMImplementationImpl
    ...
    private int docAndDoctypeCounter = 0;
         ...
         * At this writing, com.itsaky.org.apache.xerces.internal.dom supports only XML.
         *
            ...
            if ((feature.equalsIgnoreCase("+XPath"))
                ...
                try {
                    Class xpathClass = ObjectFactory.findProviderClass(
                        "com.itsaky.org.apache.xpath.internal.domapi.XPathEvaluatorImpl", true);
        ...
        if (schemaType == XMLGrammarDescription.XML_SCHEMA) {
            ...
            if(freeValidatorIndex < 0) {
                return (RevalidationHandler) (ObjectFactory
                            .newInstance(
                                "com.itsaky.org.apache.xerces.internal.impl.xs.XMLSchemaValidator",
            ...
            if(freeDTDValidatorIndex < 0) {
                return (RevalidationHandler) (ObjectFactory
                            .newInstance(
                                "com.itsaky.org.apache.xerces.internal.impl.dtd.XMLDTDValidator",
                                ObjectFactory.findClassLoader(),
                                true));
            }
            // return first available validator
