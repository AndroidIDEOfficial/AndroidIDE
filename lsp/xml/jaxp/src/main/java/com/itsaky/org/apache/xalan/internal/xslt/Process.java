 ...
 */
package com.itsaky.org.apache.xalan.internal.xslt;

import com.itsaky.org.apache.xalan.internal.Version;
import com.itsaky.org.apache.xalan.internal.res.XSLMessages;
import com.itsaky.org.apache.xalan.internal.res.XSLTErrorResources;
import com.itsaky.org.apache.xalan.internal.utils.ConfigurationError;
...
import com.itsaky.org.apache.xml.internal.utils.DefaultErrorHandler;
import com.itsaky.org.apache.xml.internal.utils.WrappedRuntimeException;
import com.itsaky.org.apache.xml.internal.utils.res.XResourceBundle;
...
/*
import com.itsaky.org.apache.xalan.internal.trace.PrintTraceListener;
import com.itsaky.org.apache.xalan.internal.trace.TraceManager;
import com.itsaky.org.apache.xalan.internal.transformer.XalanProperties;
*/
...
public class Process
{
  ...
  public static void _main(String argv[])
  {
    ...
    else
    {
      ...
      if (useXSLTC)
      {
         String key = "jaxp.xml.transform.TransformerFactory";
         String value = "com.itsaky.org.apache.xalan.internal.xsltc.trax.TransformerFactoryImpl";
      ...
      try
      {
        ...
        */
        ...
        if (null != stylesheet)
        {
          ...
          // J2SE does not support Xalan interpretive
          /*
          if (transformer instanceof com.itsaky.org.apache.xalan.internal.transformer.TransformerImpl)
          {
            com.itsaky.org.apache.xalan.internal.transformer.TransformerImpl impl = (com.itsaky.org.apache.xalan.internal.transformer.TransformerImpl)transformer;
          ...
          */
          ...
          if (null != inFileName)
          {
            ...
            else if (flavor.equals("th"))
            {
              ...
              try
              {
                jaxp.xml.parsers.SAXParserFactory factory =
                  jaxp.xml.parsers.SAXParserFactory.newInstance();
                ...
                jaxp.xml.parsers.SAXParser jaxpParser =
                  factory.newSAXParser();

                reader = jaxpParser.getXMLReader();
              }
              catch (jaxp.xml.parsers.ParserConfigurationException ex)
              {
                throw new SAXException (ex);
              }
              catch (jaxp.xml.parsers.FactoryConfigurationError ex1)
              {
              ...
              /*
              if (!useXSLTC)
                stf.setAttribute(com.itsaky.org.apache.xalan.internal.processor.TransformerFactoryImpl.FEATURE_INCREMENTAL,
                   Boolean.TRUE);
              */
