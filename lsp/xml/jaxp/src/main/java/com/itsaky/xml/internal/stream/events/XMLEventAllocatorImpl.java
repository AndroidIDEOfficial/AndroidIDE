...
import jaxp.xml.stream.*;
import jaxp.xml.stream.events.*;
...
public class XMLEventAllocatorImpl implements XMLEventAllocator {
    ...
    public jaxp.xml.stream.events.XMLEvent allocate(jaxp.xml.stream.XMLStreamReader xMLStreamReader) throws jaxp.xml.stream.XMLStreamException {
    ...
    public void allocate(jaxp.xml.stream.XMLStreamReader xMLStreamReader, jaxp.xml.stream.util.XMLEventConsumer xMLEventConsumer) throws jaxp.xml.stream.XMLStreamException {
    ...
    public jaxp.xml.stream.util.XMLEventAllocator newInstance() {
