...
public class FuncLoader
{
   ...
   * 'com.itsaky.org.apache.xpath.internal.functions'.
   *
   * @return The class name of the {com.itsaky.org.apache.xpath.internal.functions.Function} class.
   */
   ...
   *
   * @param funcName The class name of the {com.itsaky.org.apache.xpath.internal.functions.Function}
   *             class, which, if it does not have a '.' in it, is assumed to
   *             be relative to 'com.itsaky.org.apache.xpath.internal.functions'.
  ...
  Function getFunction() throws TransformerException
  {
    try
    {
      ...
      if (className.indexOf(".") < 0) {
        className = "com.itsaky.org.apache.xpath.internal.functions." + className;
      }
      //hack for loading only built-in function classes.
      String subString = className.substring(0,className.lastIndexOf('.'));
      if(!(subString.equals ("com.itsaky.org.apache.xalan.internal.templates") ||
           subString.equals ("com.itsaky.org.apache.xpath.internal.functions"))) {
