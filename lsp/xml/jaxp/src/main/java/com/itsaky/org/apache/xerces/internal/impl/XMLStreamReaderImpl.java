...
import com.itsaky.xml.internal.stream.StaxErrorReporter;
import com.itsaky.xml.internal.stream.XMLEntityStorage;
import com.itsaky.xml.internal.stream.events.EntityDeclarationImpl;
import com.itsaky.xml.internal.stream.events.NotationDeclarationImpl;
...
import com.itsaky.org.apache.xerces.internal.util.NamespaceContextWrapper;
import com.itsaky.org.apache.xerces.internal.util.SymbolTable;
import com.itsaky.xml.internal.stream.dtd.nonvalidating.XMLNotationDecl;
import com.itsaky.xml.internal.stream.dtd.nonvalidating.DTDGrammar;
...
/** This class implements jaxp.xml.stream.XMLStreamReader. It makes use of XML*Scanner classes to
 ...
 */
public class XMLStreamReaderImpl implements jaxp.xml.stream.XMLStreamReader {
    ...
    */
    ...
    private void switchToXML11Scanner() throws IOException{
        ...
        com.itsaky.org.apache.xerces.internal.xni.NamespaceContext oldNamespaceContext = fScanner.fNamespaceContext;
     ...
     * @throws IllegalStateException if this is not a START_ELEMENT or ATTRIBUTE
     */
    public jaxp.xml.namespace.QName getAttributeQName(int index) {
        //State should be either START_ELEMENT or ATTRIBUTE
        if( fEventType == XMLEvent.START_ELEMENT || fEventType == XMLEvent.ATTRIBUTE) {
            ...
            return new jaxp.xml.namespace.QName(uri, localName) ;
        } else{
            throw new java.lang.IllegalStateException("Current state is not among the states "
                     + getEventTypeString(XMLEvent.START_ELEMENT) + " , "
                     + getEventTypeString(XMLEvent.ATTRIBUTE)
     ...
     */
    public jaxp.xml.namespace.QName getName() {
        if(fEventType == XMLEvent.START_ELEMENT || fEventType == XMLEvent.END_ELEMENT)
     ...
     * @return
     */
    public jaxp.xml.namespace.QName convertXNIQNametoJavaxQName(com.itsaky.org.apache.xerces.internal.xni.QName qname){
        if (qname == null) return null;
        //xxx: prefix definition ?
        if(qname.prefix == null){
            return new jaxp.xml.namespace.QName(qname.uri, qname.localpart) ;
        } else{
            return new jaxp.xml.namespace.QName(qname.uri, qname.localpart, qname.prefix) ;
        }
    }
