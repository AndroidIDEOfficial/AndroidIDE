...
public class FastStringBuffer
{
  ...
  /**/static final int DEBUG_FORCE_INIT_BITS=0;
    ...
    static final boolean DEBUG_FORCE_FIXED_CHUNKSIZE=true;
         ...
         * chunk.
         * @see #sendNormalizedSAXcharacters(ContentHandler,int,int)
         */
   ...
   * @param start Offset of first character in the range.
   * @param length Number of characters to send.
   * @exception SAXException may be thrown by handler's
   * characters() method.
   */
  public void sendSAXcharacters(
          ContentHandler ch, int start, int length)
            throws SAXException
  {
  ...
  public void sendSAXComment(
          LexicalHandler ch, int start, int length)
            throws SAXException
  {
