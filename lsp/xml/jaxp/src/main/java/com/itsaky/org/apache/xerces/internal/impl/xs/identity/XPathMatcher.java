...
import com.itsaky.org.apache.xerces.internal.impl.xpath.XPath;
    ...
    public static void main(String[] argv) throws XNIException {
        ...
        if (DEBUG_ANY) {
            for (int i = 0; i < argv.length; i++) {
                ...
                com.itsaky.org.apache.xerces.internal.parsers.SAXParser parser =
                    new com.itsaky.org.apache.xerces.internal.parsers.SAXParser(symbols) {
