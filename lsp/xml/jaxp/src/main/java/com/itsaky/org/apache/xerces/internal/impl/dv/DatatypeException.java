...
package com.itsaky.org.apache.xerces.internal.impl.dv;
...
public class DatatypeException extends Exception {
    ...
    public String getMessage() {
        ...
        resourceBundle = SecuritySupport.getResourceBundle("com.itsaky.org.apache.xerces.internal.impl.msg.XMLSchemaMessages");
        if (resourceBundle == null)
            throw new MissingResourceException("Property file not found!", "com.itsaky.org.apache.xerces.internal.impl.msg.XMLSchemaMessages", key);

        String msg = resourceBundle.getString(key);
        if (msg == null) {
            msg = resourceBundle.getString("BadMessageKey");
            throw new MissingResourceException(msg, "com.itsaky.org.apache.xerces.internal.impl.msg.XMLSchemaMessages", key);
        }
