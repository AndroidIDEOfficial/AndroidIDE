...
import com.itsaky.org.apache.xpath.internal.XPath;
import com.itsaky.org.apache.xpath.internal.XPathContext;
import com.itsaky.org.apache.xpath.internal.XPathFactory;
...
import jaxp.xml.parsers.*;

import java.io.IOException;

/**
 * The XPathImpl class provides implementation for the methods defined  in
 * jaxp.xml.xpath.XPath interface. This provide simple access to the results
...
public class XPathImpl implements jaxp.xml.xpath.XPath {
    ...
    public Object evaluate(String expression, Object item, QName returnType)
        ...
        try {
            ...
            if ( nestedException instanceof jaxp.xml.xpath.XPathFunctionException ) {
                throw (jaxp.xml.xpath.XPathFunctionException)nestedException;
            } else {
