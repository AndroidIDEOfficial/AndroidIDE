...
public class DOM2Helper extends DOMHelper
{
   ...
   * that they implement com.itsaky.org.apache.xerces.internal.dom.NodeImpl.
   *
  ...
  public void checkNode(Node node) throws TransformerException
  {
    ...
    // if(!(node instanceof com.itsaky.org.apache.xerces.internal.dom.NodeImpl))
  ...
  public void parse(InputSource source) throws TransformerException
  {
    ...
    try
    {
      ...
      // com.itsaky.org.apache.xerces.internal.parsers.DOMParser parser
      //  = new com.itsaky.org.apache.xerces.internal.parsers.DOMParser();
    ...
    // setDocument(((com.itsaky.org.apache.xerces.internal.parsers.DOMParser)parser).getDocument());
  }
