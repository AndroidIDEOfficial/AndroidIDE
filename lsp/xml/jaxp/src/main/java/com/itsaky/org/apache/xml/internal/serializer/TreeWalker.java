...
import com.itsaky.org.apache.xml.internal.serializer.utils.AttList;
import com.itsaky.org.apache.xml.internal.serializer.utils.DOM2Helper;
...
//    TODO: </REVIEW>
    ...
    case Node.TEXT_NODE :
    {
      ...
      if (nextIsRaw)
      {
        ...
        m_contentHandler.processingInstruction(jaxp.xml.transform.Result.PI_DISABLE_OUTPUT_ESCAPING, "");
        dispatachChars(node);
        m_contentHandler.processingInstruction(jaxp.xml.transform.Result.PI_ENABLE_OUTPUT_ESCAPING, "");
      }
      else
      {
        dispatachChars(node);
