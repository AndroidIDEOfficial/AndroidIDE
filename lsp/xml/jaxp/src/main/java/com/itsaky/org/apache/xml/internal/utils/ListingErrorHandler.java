...
public class ListingErrorHandler implements ErrorHandler, ErrorListener
{
    ...
    /* ======== Implement jaxp.xml.transform.ErrorListener ======== */

    /**
     * Receive notification of a warning.
     *
     * <p>{@link jaxp.xml.transform.Transformer} can use this method to report
     ...
     *
     * @throws jaxp.xml.transform.TransformerException  only if
     * setThrowOnWarning is true.
     *
     * @see jaxp.xml.transform.TransformerException
     */
