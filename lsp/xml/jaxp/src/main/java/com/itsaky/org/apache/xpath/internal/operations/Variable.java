 ...
 */
package com.itsaky.org.apache.xpath.internal.operations;
...
import com.itsaky.org.apache.xpath.internal.ExpressionOwner;
import com.itsaky.org.apache.xpath.internal.XPathContext;
import com.itsaky.org.apache.xpath.internal.XPathVisitor;
import com.itsaky.org.apache.xpath.internal.axes.PathComponent;
import com.itsaky.org.apache.xpath.internal.axes.WalkerFactory;
import com.itsaky.org.apache.xpath.internal.objects.XNodeSet;
...
import com.itsaky.org.apache.xpath.internal.XPathVisitable;
...
public class Variable extends Expression implements PathComponent
{
   ...
   *
   * @throws jaxp.xml.transform.TransformerException if a runtime exception
   *         occurs.
   */
   ...
   * @throws jaxp.xml.transform.TransformerException
   */
  public XObject execute(XPathContext xctxt, boolean destructiveOK) throws jaxp.xml.transform.TransformerException
  {
...
//      synchronized(this)
//      {
//              com.itsaky.org.apache.xalan.internal.templates.ElemVariable vvar= getElemVariable();
//              if(null != vvar)
//              {
...
//              }
//      }
//      throw new jaxp.xml.transform.TransformerException(XSLMessages.createXPATHMessage(XPATHErrorResources.ER_VAR_NOT_RESOLVABLE, new Object[]{m_qname.toString()})); //"Variable not resolvable: "+m_qname);
//    }
  }
  ...
  /*
  public com.itsaky.org.apache.xalan.internal.templates.ElemVariable getElemVariable()
  {
    ...
    com.itsaky.org.apache.xalan.internal.templates.ElemVariable vvar = null;
    com.itsaky.org.apache.xpath.internal.ExpressionNode owner = getExpressionOwner();

    if (null != owner && owner instanceof com.itsaky.org.apache.xalan.internal.templates.ElemTemplateElement)
    {

      com.itsaky.org.apache.xalan.internal.templates.ElemTemplateElement prev =
        (com.itsaky.org.apache.xalan.internal.templates.ElemTemplateElement) owner;

      if (!(prev instanceof com.itsaky.org.apache.xalan.internal.templates.Stylesheet))
      {
        while ( prev != null && !(prev.getParentNode() instanceof com.itsaky.org.apache.xalan.internal.templates.Stylesheet) )
        {
          com.itsaky.org.apache.xalan.internal.templates.ElemTemplateElement savedprev = prev;

          while (null != (prev = prev.getPreviousSiblingElem()))
          {
            if(prev instanceof com.itsaky.org.apache.xalan.internal.templates.ElemVariable)
            {
              vvar = (com.itsaky.org.apache.xalan.internal.templates.ElemVariable) prev;
