...
class DurationImpl
    ...
    public boolean isSet(DatatypeConstants.Field field) {
        ...
        if (field == null) {
            String methodName = "jaxp.xml.datatype.Duration" + "#isSet(DatatypeConstants.Field field)" ;
                throw new NullPointerException(
    ...
    public Number getField(DatatypeConstants.Field field) {
            ...
            String methodName = "jaxp.xml.datatype.Duration" + "#isSet(DatatypeConstants.Field field) " ;
                ...
                /**
                throw new IllegalArgumentException(
                        "jaxp.xml.datatype.Duration"
                        + "#(getSet(DatatypeConstants.Field field) called with an unknown field: "
                        + field.toString()
                );
        */
        String methodName = "jaxp.xml.datatype.Duration" + "#(getSet(DatatypeConstants.Field field)";
