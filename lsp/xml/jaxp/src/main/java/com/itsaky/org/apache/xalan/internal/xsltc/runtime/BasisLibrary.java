...
package com.itsaky.org.apache.xalan.internal.xsltc.runtime;

import com.itsaky.org.apache.xalan.internal.utils.SecuritySupport;
...
import com.itsaky.org.apache.xalan.internal.xsltc.DOM;
import com.itsaky.org.apache.xalan.internal.xsltc.Translet;
import com.itsaky.org.apache.xalan.internal.xsltc.dom.AbsoluteIterator;
import com.itsaky.org.apache.xml.internal.dtm.Axis;
import com.itsaky.org.apache.xalan.internal.xsltc.dom.DOMAdapter;
import com.itsaky.org.apache.xalan.internal.xsltc.dom.MultiDOM;
import com.itsaky.org.apache.xalan.internal.xsltc.dom.SingletonIterator;
import com.itsaky.org.apache.xalan.internal.xsltc.dom.StepIterator;
import com.itsaky.org.apache.xalan.internal.xsltc.dom.ArrayNodeListIterator;
import com.itsaky.org.apache.xml.internal.dtm.DTM;
import com.itsaky.org.apache.xml.internal.dtm.DTMAxisIterator;
import com.itsaky.org.apache.xml.internal.dtm.DTMManager;
import com.itsaky.org.apache.xml.internal.dtm.ref.DTMDefaultBase;
import com.itsaky.org.apache.xml.internal.dtm.ref.DTMNodeProxy;
...
import com.itsaky.org.apache.xml.internal.serializer.NamespaceMappings;
import com.itsaky.org.apache.xml.internal.serializer.SerializationHandler;
import com.itsaky.org.apache.xml.internal.utils.XML11Char;
...
public final class BasisLibrary {
     ...
     */
    public static jaxp.w3c.dom.Node referenceToNode(Object obj, DOM dom) {
        if (obj instanceof Node || obj instanceof DTMAxisIterator) {
            DTMAxisIterator iter = referenceToNodeSet(obj);
     ...
     */
    public static DTMAxisIterator node2Iterator(jaxp.w3c.dom.Node node,
                                                Translet translet, DOM dom)
    {
        final jaxp.w3c.dom.Node inNode = node;
        ...
        NodeList nodelist = new NodeList () {
            ...
            public jaxp.w3c.dom.Node item(int index) {
                if (index == 0)
                    return inNode;
                else
                    return null;
                                        ...
                                        Translet translet, DOM dom)
    {
        ...
        for (int i = 0; i < n; ++i) {
            jaxp.w3c.dom.Node node = nodeList.item(i);
            int handle;
            if (dtmManager != null) {
                                        ...
                                        Translet translet, DOM dom)
    {
        ...
        for (int i = 0; i < nodeList.getLength(); ++i) {
            ...
            if (doc == null) {
                ...
                catch (jaxp.xml.parsers.ParserConfigurationException e) {
            ...
            Element mid;
            switch (nodeType) {
                case jaxp.w3c.dom.Node.ELEMENT_NODE:
                case jaxp.w3c.dom.Node.TEXT_NODE:
                case jaxp.w3c.dom.Node.CDATA_SECTION_NODE:
                case jaxp.w3c.dom.Node.COMMENT_NODE:
                case jaxp.w3c.dom.Node.ENTITY_REFERENCE_NODE:
                case jaxp.w3c.dom.Node.PROCESSING_INSTRUCTION_NODE:
                    mid = doc.createElementNS(null, "__dummy__");
                    mid.appendChild(doc.importNode(node, true));
                    doc.getDocumentElement().appendChild(mid);
                    ++n;
                    break;
                case jaxp.w3c.dom.Node.ATTRIBUTE_NODE:
    ...
    public static void copy(Object obj,
            ...
            if (obj instanceof DTMAxisIterator)
      {
                ...
                //((DOM)obj).copy(((com.itsaky.org.apache.xml.internal.dtm.ref.DTMDefaultBase)((DOMAdapter)obj).getDOMImpl()).getDocument(), handler);
                DOM newDom = (DOM)obj;
    ...
    static {
        String resource = "com.itsaky.org.apache.xalan.internal.xsltc.runtime.ErrorMessages";
