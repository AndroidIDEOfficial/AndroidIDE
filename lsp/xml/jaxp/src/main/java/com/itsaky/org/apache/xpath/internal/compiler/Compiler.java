...
import com.itsaky.org.apache.xml.internal.dtm.Axis;
import com.itsaky.org.apache.xml.internal.dtm.DTMFilter;
import com.itsaky.org.apache.xml.internal.dtm.DTMIterator;
import com.itsaky.org.apache.xml.internal.utils.PrefixResolver;
import com.itsaky.org.apache.xml.internal.utils.QName;
import com.itsaky.org.apache.xpath.internal.Expression;
import com.itsaky.org.apache.xpath.internal.axes.UnionPathIterator;
import com.itsaky.org.apache.xpath.internal.axes.WalkerFactory;
import com.itsaky.org.apache.xpath.internal.axes.AxesWalker;
import com.itsaky.org.apache.xpath.internal.axes.LocPathIterator;
import com.itsaky.org.apache.xpath.internal.functions.FuncExtFunction;
import com.itsaky.org.apache.xpath.internal.functions.FuncExtFunctionAvailable;
import com.itsaky.org.apache.xpath.internal.functions.Function;
import com.itsaky.org.apache.xpath.internal.functions.WrongNumberArgsException;
import com.itsaky.org.apache.xpath.internal.objects.XNumber;
import com.itsaky.org.apache.xpath.internal.objects.XString;
import com.itsaky.org.apache.xpath.internal.operations.And;
import com.itsaky.org.apache.xpath.internal.operations.Div;
import com.itsaky.org.apache.xpath.internal.operations.Equals;
import com.itsaky.org.apache.xpath.internal.operations.Gt;
import com.itsaky.org.apache.xpath.internal.operations.Gte;
import com.itsaky.org.apache.xpath.internal.operations.Lt;
import com.itsaky.org.apache.xpath.internal.operations.Lte;
import com.itsaky.org.apache.xpath.internal.operations.Minus;
import com.itsaky.org.apache.xpath.internal.operations.Mod;
import com.itsaky.org.apache.xpath.internal.operations.Mult;
import com.itsaky.org.apache.xpath.internal.operations.Neg;
import com.itsaky.org.apache.xpath.internal.operations.Bool;
import com.itsaky.org.apache.xpath.internal.operations.NotEquals;
import com.itsaky.org.apache.xpath.internal.operations.Number;
import com.itsaky.org.apache.xpath.internal.operations.Operation;
import com.itsaky.org.apache.xpath.internal.operations.Or;
import com.itsaky.org.apache.xpath.internal.operations.Plus;
import com.itsaky.org.apache.xpath.internal.operations.String;
import com.itsaky.org.apache.xpath.internal.operations.UnaryOperation;
import com.itsaky.org.apache.xpath.internal.operations.Variable;
import com.itsaky.org.apache.xpath.internal.patterns.FunctionPattern;
import com.itsaky.org.apache.xpath.internal.patterns.NodeTest;
import com.itsaky.org.apache.xpath.internal.patterns.StepPattern;
import com.itsaky.org.apache.xpath.internal.patterns.UnionPattern;
...
//      expr.setSourceLocator(m_locator);
   ...
   * @param opPos The current position in the m_opMap array.
   *
   * @return reference to {@link com.itsaky.org.apache.xpath.internal.operations.Quo} instance.
   *
   * @throws TransformerException if a error occurs creating the Expression.
   */
