...
public final class Util {
    ...
    public static String baseName(String name) {
        return com.itsaky.org.apache.xalan.internal.xsltc.compiler.util.Util.baseName(name);
    }

    public static String noExtName(String name) {
        return com.itsaky.org.apache.xalan.internal.xsltc.compiler.util.Util.noExtName(name);
    }

    public static String toJavaName(String name) {
        return com.itsaky.org.apache.xalan.internal.xsltc.compiler.util.Util.toJavaName(name);
    }
