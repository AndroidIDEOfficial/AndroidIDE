...
package com.itsaky.org.apache.xml.internal.resolver.helpers;
...
public class Namespaces {
     ...
     */
    public static String getPrefix(jaxp.w3c.dom.Element element) {
     ...
     */
    public static String getLocalName(jaxp.w3c.dom.Element element) {
        String name = element.getTagName();
     ...
     */
    public static String getNamespaceURI(jaxp.w3c.dom.Node node, String prefix) {
        if (node == null || node.getNodeType() != Node.ELEMENT_NODE) {
            return null;
        }

        if (prefix.equals("")) {
            if (((jaxp.w3c.dom.Element) node).hasAttribute("xmlns")) {
                return ((jaxp.w3c.dom.Element) node).getAttribute("xmlns");
            }
        } else {
            String nsattr = "xmlns:" + prefix;
            if (((jaxp.w3c.dom.Element) node).hasAttribute(nsattr)) {
                return ((jaxp.w3c.dom.Element) node).getAttribute(nsattr);
            }
        }
     ...
     */
    public static String getNamespaceURI(jaxp.w3c.dom.Element element) {
