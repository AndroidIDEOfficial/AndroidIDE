...
package com.itsaky.xml.internal.stream;
...
import com.itsaky.org.apache.xerces.internal.impl.PropertyManager;

import com.itsaky.xml.internal.stream.writers.XMLDOMWriterImpl;
import com.itsaky.xml.internal.stream.writers.XMLEventWriterImpl;
import com.itsaky.xml.internal.stream.writers.XMLStreamWriterImpl;
...
public class XMLOutputFactoryImpl extends XMLOutputFactory {
    ...
    public jaxp.xml.stream.XMLEventWriter createXMLEventWriter(java.io.OutputStream outputStream) throws jaxp.xml.stream.XMLStreamException {
        return createXMLEventWriter(outputStream,  null);
    }

    public jaxp.xml.stream.XMLEventWriter createXMLEventWriter(java.io.OutputStream outputStream, String encoding) throws jaxp.xml.stream.XMLStreamException {
        return new XMLEventWriterImpl(createXMLStreamWriter(outputStream, encoding));
    }

    public jaxp.xml.stream.XMLEventWriter createXMLEventWriter(jaxp.xml.transform.Result result) throws jaxp.xml.stream.XMLStreamException {
    ...
    public jaxp.xml.stream.XMLEventWriter createXMLEventWriter(java.io.Writer writer) throws jaxp.xml.stream.XMLStreamException {
        return new XMLEventWriterImpl(createXMLStreamWriter(writer));
    }

    public jaxp.xml.stream.XMLStreamWriter createXMLStreamWriter(jaxp.xml.transform.Result result) throws jaxp.xml.stream.XMLStreamException {
    ...
    public jaxp.xml.stream.XMLStreamWriter createXMLStreamWriter(java.io.Writer writer) throws jaxp.xml.stream.XMLStreamException {
        return createXMLStreamWriter(toStreamResult(null, writer, null) , null);
    }

    public jaxp.xml.stream.XMLStreamWriter createXMLStreamWriter(java.io.OutputStream outputStream) throws jaxp.xml.stream.XMLStreamException {
        return createXMLStreamWriter(outputStream, null);
    }

    public jaxp.xml.stream.XMLStreamWriter createXMLStreamWriter(java.io.OutputStream outputStream, String encoding) throws jaxp.xml.stream.XMLStreamException {
    ...
    jaxp.xml.stream.XMLStreamWriter createXMLStreamWriter(jaxp.xml.transform.stream.StreamResult sr, String encoding) throws jaxp.xml.stream.XMLStreamException {
