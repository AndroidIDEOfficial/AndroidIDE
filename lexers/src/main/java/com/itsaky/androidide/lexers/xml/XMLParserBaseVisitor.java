...
/**
 * This class provides an empty implementation of {@link XMLParserVisitor}, which can be extended to
 * create a visitor which only needs to handle a subset of the available methods.
 *
 * @param <T> The return type of the visit operation. Use {@link Void} for operations with no return
 *     type.
 */
public class XMLParserBaseVisitor<T> extends AbstractParseTreeVisitor<T>
     ...
     */
    @Override
    public T visitNonEmptyClosingElement(XMLParser.NonEmptyClosingElementContext ctx) {
        return visitChildren(ctx);
    }
    /**
     * {@inheritDoc}
     ...
     */
    @Override
    public T visitEmptyClosingElement(XMLParser.EmptyClosingElementContext ctx) {
        return visitChildren(ctx);
    }
    /**
     * {@inheritDoc}
     ...
     */
    @Override
    public T visitPrefix(XMLParser.PrefixContext ctx) {
        return visitChildren(ctx);
    }
    /**
     * {@inheritDoc}
