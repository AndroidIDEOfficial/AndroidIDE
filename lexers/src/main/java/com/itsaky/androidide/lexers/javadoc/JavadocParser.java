...
public class JavadocParser extends Parser {
    ...
    public static class DocumentationContentContext extends ParserRuleContext {
        ...
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof JavadocParserVisitor)
                return ((JavadocParserVisitor<? extends T>) visitor)
                        .visitDocumentationContent(this);
            else return visitor.visitChildren(this);
        }
    }
    ...
    public static class DescriptionLineStartContext extends ParserRuleContext {
        ...
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof JavadocParserVisitor)
                return ((JavadocParserVisitor<? extends T>) visitor)
                        .visitDescriptionLineStart(this);
            else return visitor.visitChildren(this);
        }
    }
    ...
    public static class DescriptionLineNoSpaceNoAtContext extends ParserRuleContext {
        ...
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof JavadocParserVisitor)
                return ((JavadocParserVisitor<? extends T>) visitor)
                        .visitDescriptionLineNoSpaceNoAt(this);
            else return visitor.visitChildren(this);
        }
    }
    ...
    public static class DescriptionLineElementContext extends ParserRuleContext {
        ...
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof JavadocParserVisitor)
                return ((JavadocParserVisitor<? extends T>) visitor)
                        .visitDescriptionLineElement(this);
            else return visitor.visitChildren(this);
        }
    }

    public final DescriptionLineElementContext descriptionLineElement()
            throws RecognitionException {
        DescriptionLineElementContext _localctx =
                new DescriptionLineElementContext(_ctx, getState());
                                ...
                                {
                                    {
                                        ...
                                        while (_alt != 2
                                            ...
                                            _alt =
                                                    getInterpreter()
                                                            .adaptivePredict(_input, 30, _ctx);
                                        }
                                        setState(229);
                                        braceText();
                                    }
