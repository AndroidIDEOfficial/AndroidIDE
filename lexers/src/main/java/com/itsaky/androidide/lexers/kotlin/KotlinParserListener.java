...
public interface KotlinParserListener extends ParseTreeListener {
   ...
   * @param ctx the parse tree
   */
  void enterFunctionValueParameterWithOptionalType(
      KotlinParser.FunctionValueParameterWithOptionalTypeContext ctx);
  /**
   * Exit a parse tree produced by {@link KotlinParser#functionValueParameterWithOptionalType}.
   *
   * @param ctx the parse tree
   */
  void exitFunctionValueParameterWithOptionalType(
      KotlinParser.FunctionValueParameterWithOptionalTypeContext ctx);
  /**
   ...
   * @param ctx the parse tree
   */
  void enterParenthesizedDirectlyAssignableExpression(
   ...
   * @param ctx the parse tree
   */
  void exitParenthesizedDirectlyAssignableExpression(
      KotlinParser.ParenthesizedDirectlyAssignableExpressionContext ctx);
  /**
   ...
   * @param ctx the parse tree
   */
  void enterParenthesizedAssignableExpression(
      KotlinParser.ParenthesizedAssignableExpressionContext ctx);
  /**
   * Exit a parse tree produced by {@link KotlinParser#parenthesizedAssignableExpression}.
   *
   * @param ctx the parse tree
   */
  void exitParenthesizedAssignableExpression(
      KotlinParser.ParenthesizedAssignableExpressionContext ctx);
  /**
