...
import static openjdk.tools.javac.jvm.ClassFile.CONSTANT_Class;
import static openjdk.tools.javac.jvm.ClassFile.CONSTANT_Double;
import static openjdk.tools.javac.jvm.ClassFile.CONSTANT_Dynamic;
import static openjdk.tools.javac.jvm.ClassFile.CONSTANT_Fieldref;
import static openjdk.tools.javac.jvm.ClassFile.CONSTANT_Float;
import static openjdk.tools.javac.jvm.ClassFile.CONSTANT_Integer;
import static openjdk.tools.javac.jvm.ClassFile.CONSTANT_InterfaceMethodref;
import static openjdk.tools.javac.jvm.ClassFile.CONSTANT_InvokeDynamic;
import static openjdk.tools.javac.jvm.ClassFile.CONSTANT_Long;
import static openjdk.tools.javac.jvm.ClassFile.CONSTANT_MethodHandle;
import static openjdk.tools.javac.jvm.ClassFile.CONSTANT_Methodref;
import static openjdk.tools.javac.jvm.ClassFile.CONSTANT_MethodType;
import static openjdk.tools.javac.jvm.ClassFile.CONSTANT_Module;
import static openjdk.tools.javac.jvm.ClassFile.CONSTANT_NameandType;
import static openjdk.tools.javac.jvm.ClassFile.CONSTANT_Package;
import static openjdk.tools.javac.jvm.ClassFile.CONSTANT_String;
import static openjdk.tools.javac.jvm.ClassFile.CONSTANT_Utf8;
import static openjdk.tools.javac.jvm.ClassFile.internalize;
