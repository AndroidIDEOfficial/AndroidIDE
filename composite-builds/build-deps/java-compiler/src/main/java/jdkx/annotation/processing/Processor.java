 ...
 * jdkx.annotation.processing.RoundEnvironment rounds}.  On each
 ...
 * controlled.  For example, for a {@link jdkx.tools.JavaCompiler
 * JavaCompiler} the list of candidate processors to run can be
 * {@linkplain jdkx.tools.JavaCompiler.CompilationTask#setProcessors
 * set directly} or controlled by a {@linkplain
 * jdkx.tools.StandardLocation#ANNOTATION_PROCESSOR_PATH search path}
...
public interface Processor {
     ...
     * jdkx.lang.model.SourceVersion#isIdentifier identifiers}:
     *
     * <blockquote>
     * <dl>
     ...
     *         empty set if none
     * @see jdkx.annotation.processing.SupportedOptions
     */
     ...
     * jdkx.annotation.processing.ProcessingEnvironment#getSourceVersion
     ...
     * processor}
     *
     * @see jdkx.annotation.processing.SupportedSourceVersion
