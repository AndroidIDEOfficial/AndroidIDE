...
import openjdk.tools.classfile.Attributes;
import openjdk.tools.classfile.BootstrapMethods_attribute;
import openjdk.tools.classfile.CharacterRangeTable_attribute;
import openjdk.tools.classfile.CharacterRangeTable_attribute.Entry;
import openjdk.tools.classfile.Code_attribute;
import openjdk.tools.classfile.CompilationID_attribute;
import openjdk.tools.classfile.ConstantPool;
import openjdk.tools.classfile.ConstantPool.CONSTANT_Class_info;
import openjdk.tools.classfile.ConstantPoolException;
import openjdk.tools.classfile.ConstantValue_attribute;
import openjdk.tools.classfile.DefaultAttribute;
import openjdk.tools.classfile.Deprecated_attribute;
import openjdk.tools.classfile.Descriptor;
import openjdk.tools.classfile.Descriptor.InvalidDescriptor;
import openjdk.tools.classfile.EnclosingMethod_attribute;
import openjdk.tools.classfile.Exceptions_attribute;
import openjdk.tools.classfile.InnerClasses_attribute;
import openjdk.tools.classfile.InnerClasses_attribute.Info;
import openjdk.tools.classfile.LineNumberTable_attribute;
import openjdk.tools.classfile.LocalVariableTable_attribute;
import openjdk.tools.classfile.LocalVariableTypeTable_attribute;
import openjdk.tools.classfile.MethodParameters_attribute;
import openjdk.tools.classfile.Module_attribute;
import openjdk.tools.classfile.ModuleHashes_attribute;
import openjdk.tools.classfile.ModuleMainClass_attribute;
import openjdk.tools.classfile.ModulePackages_attribute;
import openjdk.tools.classfile.ModuleResolution_attribute;
import openjdk.tools.classfile.ModuleTarget_attribute;
import openjdk.tools.classfile.NestHost_attribute;
import openjdk.tools.classfile.NestMembers_attribute;
import openjdk.tools.classfile.Record_attribute;
import openjdk.tools.classfile.RuntimeInvisibleAnnotations_attribute;
import openjdk.tools.classfile.RuntimeInvisibleParameterAnnotations_attribute;
import openjdk.tools.classfile.RuntimeInvisibleTypeAnnotations_attribute;
import openjdk.tools.classfile.RuntimeParameterAnnotations_attribute;
import openjdk.tools.classfile.RuntimeVisibleAnnotations_attribute;
import openjdk.tools.classfile.RuntimeVisibleParameterAnnotations_attribute;
import openjdk.tools.classfile.RuntimeVisibleTypeAnnotations_attribute;
import openjdk.tools.classfile.PermittedSubclasses_attribute;
import openjdk.tools.classfile.Signature_attribute;
import openjdk.tools.classfile.SourceDebugExtension_attribute;
import openjdk.tools.classfile.SourceFile_attribute;
import openjdk.tools.classfile.SourceID_attribute;
import openjdk.tools.classfile.StackMapTable_attribute;
import openjdk.tools.classfile.StackMap_attribute;
import openjdk.tools.classfile.Synthetic_attribute;
import openjdk.tools.classfile.Type;

import static openjdk.tools.classfile.AccessFlags.*;
