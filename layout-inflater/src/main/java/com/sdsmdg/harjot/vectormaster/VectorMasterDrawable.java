...
public class VectorMasterDrawable extends Drawable {
    ...
    public VectorMasterDrawable(@NonNull Context context, int resID, float offsetX, float offsetY, float scaleX, float scaleY) {
        this.resID = resID;
    ...
    @NonNull
    @Contract("_ -> new")
    public static VectorMasterDrawable fromXML (@NonNull String vectorXML) throws XmlPullParserException {
