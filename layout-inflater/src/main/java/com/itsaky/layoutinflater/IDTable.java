...
/**
 * Holds references to view IDs. The {@link #newRound()} must
...
public class IDTable {
    ...
    /**
     * Map<String, Integer> containing the IDs.
     * Entries are mapped by the name of the ID.
     *
     * For example :
     * if android:id="@+id/my_id" is provided for view,
     * then an entry will be created in this map
     * with the key : 'my_id' and a random integer as the value.
     *
     * No entries are created for views which do not have
