 ...
 * @author Akash Yadav
 */
class WidgetsItemAdapter(private val widgets: List<UiWidget>) : RecyclerView.Adapter<VH>(){
  
  inner class VH(val binding: LayoutUiWidgetsItemBinding) : RecyclerView.ViewHolder(binding.root)
  
  override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): VH {
    return VH(LayoutUiWidgetsItemBinding.inflate(LayoutInflater.from(parent.context), parent, false))
  }
