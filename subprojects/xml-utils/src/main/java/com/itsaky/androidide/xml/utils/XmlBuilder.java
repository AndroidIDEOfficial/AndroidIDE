...
public final class XmlBuilder {
  ...
  private enum Construct {
    NULL, START_TAG, ATTRIBUTE, CHARACTER_DATA, END_TAG
  }
  ...
  @NonNull
  public XmlBuilder attribute(@NonNull String namespacePrefix, @NonNull String name,
  ...
  private XmlBuilder endTagImpl(@NonNull String name, boolean useEmptyElementTag) {
    ...
    if ((lastAppendedConstruct.equals(Construct.START_TAG) ||
      lastAppendedConstruct.equals(Construct.ATTRIBUTE)) && useEmptyElementTag) {
      stringBuilder.append(" />\n");
    } else {
      indent();
