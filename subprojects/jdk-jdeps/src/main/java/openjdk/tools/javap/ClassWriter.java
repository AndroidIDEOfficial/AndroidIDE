...
import openjdk.tools.classfile.Type.ArrayType;
import openjdk.tools.classfile.Type.ClassSigType;
import openjdk.tools.classfile.Type.ClassType;
import openjdk.tools.classfile.Type.MethodType;
import openjdk.tools.classfile.Type.SimpleType;
import openjdk.tools.classfile.Type.TypeParamType;
import openjdk.tools.classfile.Type.WildcardType;

import static openjdk.tools.classfile.AccessFlags.*;
import static openjdk.tools.classfile.ConstantPool.CONSTANT_Module;
import static openjdk.tools.classfile.ConstantPool.CONSTANT_Package;
