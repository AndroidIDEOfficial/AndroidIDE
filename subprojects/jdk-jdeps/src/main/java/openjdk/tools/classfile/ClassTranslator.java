...
package openjdk.tools.classfile;

import java.util.Map;

import openjdk.tools.classfile.ConstantPool.CONSTANT_Class_info;
import openjdk.tools.classfile.ConstantPool.CONSTANT_Dynamic_info;
import openjdk.tools.classfile.ConstantPool.CONSTANT_Double_info;
import openjdk.tools.classfile.ConstantPool.CONSTANT_Fieldref_info;
...
import openjdk.tools.classfile.ConstantPool.CONSTANT_InterfaceMethodref_info;
import openjdk.tools.classfile.ConstantPool.CONSTANT_InvokeDynamic_info;
import openjdk.tools.classfile.ConstantPool.CONSTANT_Long_info;
import openjdk.tools.classfile.ConstantPool.CONSTANT_MethodHandle_info;
import openjdk.tools.classfile.ConstantPool.CONSTANT_MethodType_info;
import openjdk.tools.classfile.ConstantPool.CONSTANT_Methodref_info;
import openjdk.tools.classfile.ConstantPool.CONSTANT_Module_info;
import openjdk.tools.classfile.ConstantPool.CONSTANT_NameAndType_info;
import openjdk.tools.classfile.ConstantPool.CONSTANT_Package_info;
