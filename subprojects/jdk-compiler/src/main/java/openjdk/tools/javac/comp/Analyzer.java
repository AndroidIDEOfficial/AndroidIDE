...
import static openjdk.tools.javac.code.Flags.GENERATEDCONSTR;
import static openjdk.tools.javac.code.TypeTag.CLASS;
import static openjdk.tools.javac.tree.JCTree.Tag.APPLY;
import static openjdk.tools.javac.tree.JCTree.Tag.FOREACHLOOP;
import static openjdk.tools.javac.tree.JCTree.Tag.LABELLED;
import static openjdk.tools.javac.tree.JCTree.Tag.METHODDEF;
import static openjdk.tools.javac.tree.JCTree.Tag.NEWCLASS;
import static openjdk.tools.javac.tree.JCTree.Tag.NULLCHK;
...
public class Analyzer {
    ...
    /**
     * Subclass of {@link openjdk.tools.javac.tree.TreeScanner} which visit AST-nodes w/o crossing
