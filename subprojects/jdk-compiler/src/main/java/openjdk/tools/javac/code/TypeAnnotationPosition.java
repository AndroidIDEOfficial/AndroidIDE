...
*/
// Code duplicated in openjdk.tools.classfile.TypeAnnotation.Position
public class TypeAnnotationPosition {
    ...
    // openjdk.tools.javac.jvm.Gen.genCatch, we first use this to hold
    // the catch type's constant pool entry index.  Then in
    // openjdk.tools.javac.jvm.Code.fillExceptionParameterPositions we
