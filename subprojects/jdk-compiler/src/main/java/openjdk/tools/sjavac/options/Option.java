...
package openjdk.tools.sjavac.options;
...
import openjdk.tools.sjavac.CopyFile;
 ...
 * option values, refer to openjdk.tools.sjavac.options.Options.
 *
...
public enum Option {
    ...
    TR("-tr", "Translate resources") {
        ...
        protected void processMatching(ArgumentIterator iter, OptionHelper helper) {
            ...
            //   .prop=openjdk.tools.javac.smart.CompileProperties
            //   .idl=openjdk.corba.CompileIdl
