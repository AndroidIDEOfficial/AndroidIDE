...
dependencies {
  ...
  androidTestImplementation(projects.lsp.java)
  androidTestImplementation(projects.shared)
  androidTestImplementation(projects.subprojects.database)
  androidTestImplementation(projects.subprojects.indexing)
}