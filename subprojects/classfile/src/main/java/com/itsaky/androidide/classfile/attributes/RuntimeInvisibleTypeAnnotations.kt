...
/**
 * Stores run-time invisible annotations on type parameter declarations of generic classes,
 * interfaces, methods, and constructors.
 *
 * @author Akash Yadav
 */
class RuntimeInvisibleTypeAnnotations(nameIndex: Int) : AnnotationAttr(nameIndex) {
  override val type: Type = RUNTIME_INVISIBLE_TYPE_ANNOTATIONS
  
  /**
   * The annotations always of type [TypeAnnotation]
   */
  var typeAnnotations: Array<TypeAnnotation> = emptyArray()
}
