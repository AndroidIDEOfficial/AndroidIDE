 ...
 *
 * Names of {@linkplain
 * jdkx.lang.model.element.ExecutableElement#getParameters()
 * parameters} may not be recoverable from class files.
 *
 * The {@linkplain jdkx.lang.model.element.Modifier modifiers} on an
 ...
 * jdkx.lang.model.util.Elements.Origin#MANDATED mandated} may not be
 * marked as such when created from class files.
 *
 * Additionally, {@linkplain
 * jdkx.lang.model.util.Elements.Origin#SYNTHETIC synthetic}
 * constructs in a class file, such as accessor methods used in
 * implementing nested classes and {@linkplain
 * jdkx.lang.model.util.Elements.Origin#isBridge(ExecutableElement)
 ...
 * @see jdkx.lang.model.util.Elements
